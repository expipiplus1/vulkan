...
--     additional modes.
--
-- -   #extension-features-stencilResolveModes#
...
--
-- -   #extension-features-independentResolveNone# @independentResolveNone@
...
--     values when one of those modes is
...
--     @sType@ /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES'
--
-- = See Also
--
