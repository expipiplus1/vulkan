...
--     bind point
--
-- -   #VUID-vkCmdDrawIndirectCount-commandBuffer-08614# If @commandBuffer@
...
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08615# If the
--     'Vulkan.Core10.Handles.Pipeline' object bound to the pipeline bind
--     point used by this command or any
--     'Vulkan.Extensions.Handles.ShaderEXT' bound to a stage corresponding
--     to the pipeline bind point used by this command accesses a
...
--
-- -   #VUID-vkCmdDrawIndirectCount-ConstOffset-08616# If the
--     'Vulkan.Core10.Handles.Pipeline' object bound to the pipeline bind
--     point used by this command or any
--     'Vulkan.Extensions.Handles.ShaderEXT' bound to a stage corresponding
--     to the pipeline bind point used by this command accesses a
...
--     command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07834# If the bound graphics
--     pipeline state was created with the
...
--     command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08620# If a shader object is bound
--     to any graphics stage, and the most recent call to
...
--     command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07836# If the bound graphics
--     pipeline state was created with the
...
--     command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08622# If a shader object is bound
--     to any graphics stage, and the most recent call to
...
--     command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07837# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08623# If a shader object is bound
--     to any graphics stage, and the most recent call to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07838# If the bound graphics
--     pipeline state was created with the
...
--     command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08624# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetStencilTestEnable'
--     in the current command buffer set @stencilTestEnable@ to
--     'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07839# If the bound graphics
--     pipeline state was created with the
...
--     command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08625# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetStencilTestEnable'
--     in the current command buffer set @stencilTestEnable@ to
--     'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08626# If a shader object is bound
--     to any graphics stage, and the most recent call to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-sampleLocationsPerPixel-07934# If the
...
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07840# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08627# If a shader object is bound
--     to any graphics stage,
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetCullMode'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07841# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08628# If a shader object is bound
--     to any graphics stage,
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetFrontFace'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07843# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08629# If a shader object is bound
--     to any graphics stage,
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthTestEnable'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07844# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08630# If a shader object is bound
--     to any graphics stage,
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthWriteEnable'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07845# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08631# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthTestEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07846# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08632# If a shader object is bound
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07847# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08633# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07848# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08634# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', and the most recent call to
...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetScissorWithCount'
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08635# If a shader object is bound
...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetViewportWithCount'
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08636# If a shader object is bound
...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetViewportWithCount'
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08637# If a shader object is bound
--     to any graphics stage, and the
...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetViewportWithCount'
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07878# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07879# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08638# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_NV_scissor_exclusive.cmdSetExclusiveScissorEnableNV'
--     in the current command buffer set any element of
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08639# If a shader object is bound
--     to any graphics stage, then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-04877# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08640# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-logicOp-04878# If the bound graphics
--     pipeline state was created with the
...
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08641# If a shader object is bound
--     to any graphics stage, and the
...
--
-- -   #VUID-vkCmdDrawIndirectCount-colorAttachmentCount-06180# If the
--     current render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@colorAttachmentCount@
...
--
-- -   #VUID-vkCmdDrawIndirectCount-colorAttachmentCount-07616# If the
--     current render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@colorAttachmentCount@
...
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07880# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08648# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07881# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08649# If the
--     @VK_EXT_discard_rectangles@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
...
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@pDepthAttachment->imageView@
--
-- -   #VUID-vkCmdDrawIndirectCount-pDepthAttachment-07617# If the current
--     render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@pDepthAttachment->imageView@
...
--
-- -   #VUID-vkCmdDrawIndirectCount-pStencilAttachment-06182# If the
--     current render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
...
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@pStencilAttachment->imageView@
--
-- -   #VUID-vkCmdDrawIndirectCount-pStencilAttachment-07618# If the
--     current render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@pStencilAttachment->imageView@
...
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07619# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08650# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07621# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08651# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07622# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08652# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07623# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08653# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07624# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08654# If a shader object is bound
--     to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07625# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08655# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07626# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08656# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-logicOp logicOp>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07630# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08660# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07631# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08661# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07632# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08662# If the
--     @VK_EXT_conservative_rasterization@ extension is enabled, and a
--     shader object is bound to any graphics stage, and the most recent
--     call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07633# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08663# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07634# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08664# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07636# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08665# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08666# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08667# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08668# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08669# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetPolygonModeEXT'
--     in the current command buffer set @polygonMode@ to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08670# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object is bound to the vertex stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetPrimitiveTopology'
--     in the current command buffer set @primitiveTopology@ to any line
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08671# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object that outputs line primitives is bound to the tessellation
--     evaluation or geometry stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetLineStippleEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07849# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08672# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetLineStippleEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07639# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08673# If the
...
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07640# If the bound graphics
--     pipeline state was created with the
...
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08674# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07641# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08675# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07642# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08676# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07643# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08677# If the
--     @VK_NV_fragment_coverage_to_color@ extension is enabled, and a
--     shader object is bound to any graphics stage, and the most recent
--     call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageToColorEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07644# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08678# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07645# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08679# If the
--     @VK_NV_framebuffer_mixed_samples@ extension is enabled, and a shader
--     object is bound to any graphics stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageModulationTableEnableNV'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07646# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08680# If the
--     @VK_NV_framebuffer_mixed_samples@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageModulationTableEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07647# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08681# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-shadingRateImage shadingRateImage>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetShadingRateImageEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07648# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08682# If the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07649# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08683# If the
...
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetRasterizationSamplesEXT'
--
-- -   #VUID-vkCmdDrawIndirectCount-multisampledRenderToSingleSampled-07475#
...
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetRasterizationSamplesEXT'
--
-- -   #VUID-vkCmdDrawIndirectCount-sampleLocationsEnable-07484# If the
...
--     bit set
--
-- -   #VUID-vkCmdDrawIndirectCount-sampleLocationsEnable-07485# If the
--     bound graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_SAMPLE_LOCATIONS_EXT'
--     state enabled and the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_SAMPLE_LOCATIONS_ENABLE_EXT'
...
--
-- -   #VUID-vkCmdDrawIndirectCount-sampleLocationsEnable-07486# If the
--     bound graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_SAMPLE_LOCATIONS_EXT'
--     state enabled and the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_SAMPLE_LOCATIONS_ENABLE_EXT'
...
--     with a @samples@ parameter equaling @rasterizationSamples@
--
-- -   #VUID-vkCmdDrawIndirectCount-sampleLocationsEnable-07487# If the
--     bound graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_SAMPLE_LOCATIONS_ENABLE_EXT'
--     state enabled, and if @sampleLocationsEnable@ was
--     'Vulkan.Core10.FundamentalTypes.TRUE' in the last call to
...
--
-- -   #VUID-vkCmdDrawIndirectCount-stage-07073# If the currently bound
...
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07842# If the bound graphics
--     pipeline state was created with the
...
--     draw command
--
-- -   #VUID-vkCmdDrawIndirectCount-Input-07939# If the bound graphics
--     pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_VERTEX_INPUT_EXT'
...
--     bind point
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-commandBuffer-08614# If
...
--     not be a protected resource
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08615# If the
--     'Vulkan.Core10.Handles.Pipeline' object bound to the pipeline bind
--     point used by this command or any
--     'Vulkan.Extensions.Handles.ShaderEXT' bound to a stage corresponding
--     to the pipeline bind point used by this command accesses a
...
--     @OpImageSparseSample*@ instructions
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-ConstOffset-08616# If the
--     'Vulkan.Core10.Handles.Pipeline' object bound to the pipeline bind
--     point used by this command or any
--     'Vulkan.Extensions.Handles.ShaderEXT' bound to a stage corresponding
--     to the pipeline bind point used by this command accesses a
...
--     command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07834# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_BIAS' dynamic
--     state enabled then
--     'Vulkan.Core10.CommandBufferBuilding.cmdSetDepthBias' /must/ have
...
--     command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08620# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetDepthBiasEnable'
--     in the current command buffer set @depthBiasEnable@ to
--     'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07836# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_BOUNDS'
--     dynamic state enabled then
--     'Vulkan.Core10.CommandBufferBuilding.cmdSetDepthBounds' /must/ have
...
--     command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08622# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthBoundsTestEnable'
--     in the current command buffer set @depthBoundsTestEnable@ to
--     'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07837# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_STENCIL_COMPARE_MASK'
--     dynamic state enabled then
--     'Vulkan.Core10.CommandBufferBuilding.cmdSetStencilCompareMask'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08623# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetStencilTestEnable'
--     in the current command buffer set @stencilTestEnable@ to
--     'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07838# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_STENCIL_WRITE_MASK'
--     dynamic state enabled then
--     'Vulkan.Core10.CommandBufferBuilding.cmdSetStencilWriteMask' /must/
...
--     command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08624# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetStencilTestEnable'
--     in the current command buffer set @stencilTestEnable@ to
--     'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07839# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_STENCIL_REFERENCE'
--     dynamic state enabled then
--     'Vulkan.Core10.CommandBufferBuilding.cmdSetStencilReference' /must/
...
--     command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08625# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetStencilTestEnable'
--     in the current command buffer set @stencilTestEnable@ to
--     'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08626# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetSampleLocationsEnableEXT'
--     in the current command buffer set @sampleLocationsEnable@ to
--     'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     structure the bound graphics pipeline has been created with
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07840# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_CULL_MODE' dynamic
--     state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetCullMode'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08627# If a shader object
--     is bound to any graphics stage,
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetCullMode'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07841# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_FRONT_FACE' dynamic
--     state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetFrontFace'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08628# If a shader object
--     is bound to any graphics stage,
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetFrontFace'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07843# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_TEST_ENABLE'
--     dynamic state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthTestEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08629# If a shader object
--     is bound to any graphics stage,
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthTestEnable'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07844# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_WRITE_ENABLE'
--     dynamic state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthWriteEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08630# If a shader object
--     is bound to any graphics stage,
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthWriteEnable'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07845# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_COMPARE_OP'
--     dynamic state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthCompareOp'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08631# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthTestEnable'
--     in the current command buffer set @depthTestEnable@ to
--     'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07846# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_BOUNDS_TEST_ENABLE'
--     dynamic state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetDepthBoundsTestEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08632# If a shader object
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07847# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_STENCIL_TEST_ENABLE'
--     dynamic state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetStencilTestEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08633# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07848# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_STENCIL_OP' dynamic
--     state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetStencilOp'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08634# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', and the most recent call to
...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetScissorWithCount'
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08635# If a shader object
...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetViewportWithCount'
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08636# If a shader object
...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetViewportWithCount'
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08637# If a shader object
--     is bound to any graphics stage, and the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-shadingRateImage shadingRateImage>
--     feature is enabled on the device, then the @viewportCount@ parameter
--     in the last call to
...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetViewportWithCount'
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07878# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_EXCLUSIVE_SCISSOR_ENABLE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_NV_scissor_exclusive.cmdSetExclusiveScissorEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07879# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_EXCLUSIVE_SCISSOR_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_NV_scissor_exclusive.cmdSetExclusiveScissorNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08638# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_NV_scissor_exclusive.cmdSetExclusiveScissorEnableNV'
--     in the current command buffer set any element of
--     @pExclusiveScissorEnables@ to 'Vulkan.Core10.FundamentalTypes.TRUE',
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08639# If a shader object
--     is bound to any graphics stage, then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-04877# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_BIAS_ENABLE'
--     dynamic state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetDepthBiasEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08640# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-logicOp-04878# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_LOGIC_OP_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state2.cmdSetLogicOpEXT'
...
--     'Vulkan.Core10.Enums.LogicOp.LogicOp' value
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08641# If a shader object
--     is bound to any graphics stage, and the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-logicOp logicOp>
--     feature is enabled on the device, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
...
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@colorAttachmentCount@
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-colorAttachmentCount-06180# If
--     the current render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@colorAttachmentCount@
...
--     used to create the currently bound graphics pipeline
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-colorAttachmentCount-07616# If
--     the current render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@colorAttachmentCount@
...
--     'Vulkan.Extensions.VK_EXT_discard_rectangles.PipelineDiscardRectangleStateCreateInfoEXT'::@discardRectangleCount@
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07880# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DISCARD_RECTANGLE_ENABLE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_discard_rectangles.cmdSetDiscardRectangleEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08648# If the
--     @VK_EXT_discard_rectangles@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07881# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DISCARD_RECTANGLE_MODE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_discard_rectangles.cmdSetDiscardRectangleModeEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08649# If the
--     @VK_EXT_discard_rectangles@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
...
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@pDepthAttachment->imageView@
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-pDepthAttachment-07617# If the
--     current render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@pDepthAttachment->imageView@
...
--     to 'Vulkan.Core10.Enums.Format.FORMAT_UNDEFINED'
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-pStencilAttachment-06182# If the
--     current render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@pStencilAttachment->imageView@
...
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@pStencilAttachment->imageView@
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-pStencilAttachment-07618# If the
--     current render pass instance was begun with
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.cmdBeginRendering'
--     and
--     'Vulkan.Core13.Promoted_From_VK_KHR_dynamic_rendering.RenderingInfo'::@pStencilAttachment->imageView@
...
--     'Vulkan.Extensions.VK_EXT_transform_feedback.PipelineRasterizationStateStreamCreateInfoEXT'::@rasterizationStream@
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07619# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_TESSELLATION_DOMAIN_ORIGIN_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetTessellationDomainOriginEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08650# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-depthClamp depthClamp>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07621# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_POLYGON_MODE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetPolygonModeEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08651# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07622# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_RASTERIZATION_SAMPLES_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetRasterizationSamplesEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08652# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07623# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_SAMPLE_MASK_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetSampleMaskEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08653# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07624# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_ALPHA_TO_COVERAGE_ENABLE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetAlphaToCoverageEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08654# If a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
--     'Vulkan.Core10.FundamentalTypes.FALSE', then
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07625# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_ALPHA_TO_ONE_ENABLE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetAlphaToOneEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08655# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-alphaToOne alphaToOne>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07626# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_LOGIC_OP_ENABLE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetLogicOpEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08656# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-logicOp logicOp>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07630# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_RASTERIZATION_STREAM_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetRasterizationStreamEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08660# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-geometryStreams geometryStreams>
--     feature is enabled, and a shader object is bound to the geometry
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetRasterizationStreamEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07631# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_CONSERVATIVE_RASTERIZATION_MODE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetConservativeRasterizationModeEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08661# If the
--     @VK_EXT_conservative_rasterization@ extension is enabled, and a
--     shader object is bound to any graphics stage, and the most recent
--     call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07632# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_EXTRA_PRIMITIVE_OVERESTIMATION_SIZE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetExtraPrimitiveOverestimationSizeEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08662# If the
--     @VK_EXT_conservative_rasterization@ extension is enabled, and a
--     shader object is bound to any graphics stage, and the most recent
--     call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07633# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_CLIP_ENABLE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetDepthClipEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08663# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-depthClipEnable depthClipEnable>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetDepthClipEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07634# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_SAMPLE_LOCATIONS_ENABLE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetSampleLocationsEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08664# If the
--     @VK_EXT_sample_locations@ extension is enabled, and a shader object
--     is bound to any graphics stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07636# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_PROVOKING_VERTEX_MODE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetProvokingVertexModeEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08665# If the
--     @VK_EXT_provoking_vertex@ extension is enabled, and a shader object
--     is bound to the vertex stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetProvokingVertexModeEXT'
--     /must/ have been called in the current command buffer prior to this
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08666# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetPolygonModeEXT'
--     in the current command buffer set @polygonMode@ to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08667# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object is bound to the vertex stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetPrimitiveTopology'
--     in the current command buffer set @primitiveTopology@ to any line
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08668# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object that outputs line primitives is bound to the tessellation
--     evaluation or geometry stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetLineRasterizationModeEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08669# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetPolygonModeEXT'
--     in the current command buffer set @polygonMode@ to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08670# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object is bound to the vertex stage, and the most recent call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetPrimitiveTopology'
--     in the current command buffer set @primitiveTopology@ to any line
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08671# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object that outputs line primitives is bound to the tessellation
--     evaluation or geometry stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetLineStippleEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07849# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_LINE_STIPPLE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_line_rasterization.cmdSetLineStippleEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08672# If the
--     @VK_EXT_line_rasterization@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetLineStippleEnableEXT'
--     in the current command buffer set @stippledLineEnable@ to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07639# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_CLIP_NEGATIVE_ONE_TO_ONE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetDepthClipNegativeOneToOneEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08673# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-depthClipControl depthClipControl>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetDepthClipNegativeOneToOneEXT'
...
--     drawing command ifdef::VK_EXT_extended_dynamic_state3
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07640# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_VIEWPORT_W_SCALING_ENABLE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetViewportWScalingEnableNV'
...
--     drawing command endif::VK_EXT_extended_dynamic_state3
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08674# If the
--     @VK_NV_clip_space_w_scaling@ extension is enabled, and a shader
--     object is bound to any graphics stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetViewportWScalingEnableNV'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07641# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_VIEWPORT_SWIZZLE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetViewportSwizzleNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08675# If the
--     @VK_NV_viewport_swizzle@ extension is enabled, and a shader object
--     is bound to any graphics stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetViewportSwizzleNV'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07642# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_COVERAGE_TO_COLOR_ENABLE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageToColorEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08676# If the
--     @VK_NV_fragment_coverage_to_color@ extension is enabled, and a
--     shader object is bound to any graphics stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageToColorEnableNV'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07643# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_COVERAGE_TO_COLOR_LOCATION_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageToColorLocationNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08677# If the
--     @VK_NV_fragment_coverage_to_color@ extension is enabled, and a
--     shader object is bound to any graphics stage, and the most recent
--     call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageToColorEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07644# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_COVERAGE_MODULATION_MODE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageModulationModeNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08678# If the
--     @VK_NV_framebuffer_mixed_samples@ extension is enabled, and a shader
--     object is bound to any graphics stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageModulationModeNV'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07645# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_COVERAGE_MODULATION_TABLE_ENABLE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageModulationTableEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08679# If the
--     @VK_NV_framebuffer_mixed_samples@ extension is enabled, and a shader
--     object is bound to any graphics stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageModulationTableEnableNV'
--     /must/ have been called in the current command buffer prior to this
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07646# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_COVERAGE_MODULATION_TABLE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageModulationTableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08680# If the
--     @VK_NV_framebuffer_mixed_samples@ extension is enabled, and a shader
--     object is bound to any graphics stage, and the most recent call to
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageModulationTableEnableNV'
--     in the current command buffer set @coverageModulationTableEnable@ to
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07647# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_SHADING_RATE_IMAGE_ENABLE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetShadingRateImageEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08681# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-shadingRateImage shadingRateImage>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetShadingRateImageEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07648# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_REPRESENTATIVE_FRAGMENT_TEST_ENABLE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetRepresentativeFragmentTestEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08682# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-representativeFragmentTest representativeFragmentTest>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetRepresentativeFragmentTestEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07649# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_COVERAGE_REDUCTION_MODE_NV'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageReductionModeNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08683# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-coverageReductionMode coverageReductionMode>
--     feature is enabled, and a shader object is bound to any graphics
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetCoverageReductionModeNV'
...
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetRasterizationSamplesEXT'
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-multisampledRenderToSingleSampled-07475#
--     If the bound graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_RASTERIZATION_SAMPLES_EXT'
--     state enabled, and none of the @VK_AMD_mixed_attachment_samples@
--     extension, @VK_NV_framebuffer_mixed_samples@ extension, or the
...
--     'Vulkan.Extensions.VK_EXT_conservative_rasterization.CONSERVATIVE_RASTERIZATION_MODE_DISABLED_EXT'
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-stage-07073# If the currently
...
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#fxvertex-input ???>
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07842# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_PRIMITIVE_TOPOLOGY'
--     dynamic state enabled then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetPrimitiveTopology'
...
--     draw command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-Input-07939# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_VERTEX_INPUT_EXT'
--     dynamic state enabled, then all variables with the @Input@ storage
--     class decorated with @Location@ in the @Vertex@ @Execution@ @Model@
