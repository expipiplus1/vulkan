...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetViewportWithCount'
--
-- -   #VUID-vkCmdDrawIndirectCount-None-09232# If a shader object is bound
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-shadingRateImage-09234# If a shader
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-exclusiveScissor-09235# If a shader
--     object is bound to any graphics stage, and the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-07620# If the bound graphics
--     pipeline state was created with the
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-09237# If a shader object is bound
--     to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_TESSELLATION_EVALUATION_BIT'
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetTessellationDomainOriginEXT'
...
--     /must/ not be active
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08877# If the bound graphics
--     pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_ATTACHMENT_FEEDBACK_LOOP_ENABLE_EXT'
--     dynamic state
--     'Vulkan.Extensions.VK_EXT_attachment_feedback_loop_dynamic_state.cmdSetAttachmentFeedbackLoopEnableEXT'
...
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08880# If a shader object is bound
--     to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_FRAGMENT_BIT'
--     stage and the
...
--     /must/ not be @NULL@
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08881# If a shader object is bound
--     to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_VERTEX_BIT'
--     stage, then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetPrimitiveTopology'
...
--
-- -   #VUID-vkCmdDrawIndirectCount-Input-08734# If the bound graphics
--     pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_VERTEX_INPUT_EXT'
...
--     format
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08882# If a shader object is bound
--     to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_VERTEX_BIT'
--     stage, then
--     'Vulkan.Extensions.VK_EXT_vertex_input_dynamic_state.cmdSetVertexInputEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-None-08883# If a shader object is bound
--     to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_TESSELLATION_EVALUATION_BIT'
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state2.cmdSetPatchControlPointsEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndirectCount-rasterizerDiscardEnable-08884# If a
--     shader object is bound to any graphics stage, and the most recent
--     call to
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state2.cmdSetRasterizerDiscardEnable'
--     in the current command buffer set @rasterizerDiscardEnable@ to
...
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetViewportWithCount'
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-09232# If a shader object
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-shadingRateImage-09234# If a
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-exclusiveScissor-09235# If a
--     shader object is bound to any graphics stage, and the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-exclusiveScissor exclusiveScissor>
--     feature is enabled, then
--     'Vulkan.Extensions.VK_NV_scissor_exclusive.cmdSetExclusiveScissorEnableNV'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-07620# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_DEPTH_CLAMP_ENABLE_EXT'
--     dynamic state enabled then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetDepthClampEnableEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-09237# If a shader object
--     is bound to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_TESSELLATION_EVALUATION_BIT'
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state3.cmdSetTessellationDomainOriginEXT'
...
--     /must/ not be active
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08877# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_ATTACHMENT_FEEDBACK_LOOP_ENABLE_EXT'
--     dynamic state
--     'Vulkan.Extensions.VK_EXT_attachment_feedback_loop_dynamic_state.cmdSetAttachmentFeedbackLoopEnableEXT'
...
--     @DepthReplacing@ or @StencilRefReplacingEXT@ execution modes
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08880# If a shader object
--     is bound to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_FRAGMENT_BIT'
--     stage and the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-attachmentFeedbackLoopDynamicState attachmentFeedbackLoopDynamicState>
...
--     /must/ not be @NULL@
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08881# If a shader object
--     is bound to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_VERTEX_BIT'
--     stage, then
--     'Vulkan.Core13.Promoted_From_VK_EXT_extended_dynamic_state.cmdSetPrimitiveTopology'
...
--     'Vulkan.Extensions.VK_EXT_vertex_input_dynamic_state.VertexInputAttributeDescription2EXT'::@location@
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-Input-08734# If the bound
--     graphics pipeline state was created with the
--     'Vulkan.Core10.Enums.DynamicState.DYNAMIC_STATE_VERTEX_INPUT_EXT'
--     dynamic state enabled, then the numeric type associated with all
--     @Input@ variables of the corresponding @Location@ in the @Vertex@
...
--     format
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08882# If a shader object
--     is bound to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_VERTEX_BIT'
--     stage, then
--     'Vulkan.Extensions.VK_EXT_vertex_input_dynamic_state.cmdSetVertexInputEXT'
...
--     drawing command
--
-- -   #VUID-vkCmdDrawIndexedIndirectCount-None-08883# If a shader object
--     is bound to the
--     'Vulkan.Core10.Enums.ShaderStageFlagBits.SHADER_STAGE_TESSELLATION_EVALUATION_BIT'
--     stage, then
--     'Vulkan.Extensions.VK_EXT_extended_dynamic_state2.cmdSetPatchControlPointsEXT'
