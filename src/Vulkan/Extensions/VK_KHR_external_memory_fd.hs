...
getMemoryFdKHR :: forall io
                . (MonadIO io)
               => -- No documentation found for Nested "vkGetMemoryFdKHR" "device"
                  Device
               -> -- No documentation found for Nested "vkGetMemoryFdKHR" "pGetFdInfo"
                  MemoryGetFdInfoKHR
               -> io (("fd" ::: Int32))
...
getMemoryFdPropertiesKHR :: forall io
                          . (MonadIO io)
                         => -- No documentation found for Nested "vkGetMemoryFdPropertiesKHR" "device"
                            Device
                         -> -- No documentation found for Nested "vkGetMemoryFdPropertiesKHR" "handleType"
                            ExternalMemoryHandleTypeFlagBits
                         -> -- No documentation found for Nested "vkGetMemoryFdPropertiesKHR" "fd"
                            ("fd" ::: Int32)
