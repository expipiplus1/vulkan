...
-- = Description
--
-- -   #features-fragmentShadingRateEnums# @fragmentShadingRateEnums@
--     indicates that the implementation supports specifying fragment
...
--     @maxFragmentShadingRateInvocationCount@ indicates the maximum number
--     of fragment shader invocations per fragment supported in pipeline,
