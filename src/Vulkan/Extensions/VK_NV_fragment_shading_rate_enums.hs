...
cmdSetFragmentShadingRateEnumNV commandBuffer
  ...
  lift $ traceAroundEvent "vkCmdSetFragmentShadingRateEnumNV" (vkCmdSetFragmentShadingRateEnumNV'
...
instance FromCStruct PhysicalDeviceFragmentShadingRateEnumsFeaturesNV where
  peekCStruct p = do
    ...
    pure $ PhysicalDeviceFragmentShadingRateEnumsFeaturesNV
             ...
             (bool32ToBool supersampleFragmentShadingRates)
             (bool32ToBool noInvocationFragmentShadingRates)
