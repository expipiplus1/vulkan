...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkDebugUtilsLabelEXT-sType-sType# @sType@ /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT'
--
-- -   #VUID-VkDebugUtilsLabelEXT-pNext-pNext# @pNext@ /must/ be @NULL@
--
-- -   #VUID-VkDebugUtilsLabelEXT-pLabelName-parameter# @pLabelName@ /must/
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkDebugUtilsMessengerCreateInfoEXT-sType-sType# @sType@ /must/
--     be
