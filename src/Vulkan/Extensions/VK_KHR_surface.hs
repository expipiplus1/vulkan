...
-- 'Vulkan.Extensions.VK_EXT_swapchain_colorspace.COLOR_SPACE_SRGB_NONLINEAR_KHR'
...
-- = See Also
--
-- 'Vulkan.Extensions.VK_EXT_display_surface_counter.CompositeAlphaFlagsKHR',
...
data SurfaceCapabilitiesKHR = SurfaceCapabilitiesKHR
  ...
  , -- | @supportedUsageFlags@ is a bitmask of
    ...
    -- created with
    -- 'Vulkan.Extensions.VK_KHR_shared_presentable_image.PresentModeKHR' set
    -- to
...
data SurfaceFormatKHR = SurfaceFormatKHR
  ...
  , -- | @colorSpace@ is a presentation
    -- 'Vulkan.Extensions.VK_EXT_swapchain_colorspace.ColorSpaceKHR' that is
