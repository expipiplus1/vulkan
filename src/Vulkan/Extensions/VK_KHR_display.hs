...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkDisplayModeCreateInfoKHR-sType-sType# @sType@ /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_DISPLAY_MODE_CREATE_INFO_KHR'
--
-- -   #VUID-VkDisplayModeCreateInfoKHR-pNext-pNext# @pNext@ /must/ be
--     @NULL@
--
-- -   #VUID-VkDisplayModeCreateInfoKHR-flags-zerobitmask# @flags@ /must/
--     be @0@
--
