...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkDebugReportCallbackCreateInfoEXT-sType-sType# @sType@ /must/
--     be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT'
--
-- -   #VUID-VkDebugReportCallbackCreateInfoEXT-flags-parameter# @flags@
--     /must/ be a valid combination of 'DebugReportFlagBitsEXT' values
--
