...
--         <https://registry.khronos.org/OpenGL/extensions/ARB/ARB_post_depth_coverage.txt GL_ARB_post_depth_coverage>
--         and
--         <https://registry.khronos.org/OpenGL/extensions/EXT/EXT_post_depth_coverage.txt GL_EXT_post_depth_coverage>
--
-- [__Contributors__]
--
--     -   Jeff Bolz, NVIDIA
