{-# language CPP #-}
-- No documentation found for Chapter "VK_QCOM_rotated_copy_commands"
...
-- No documentation found for TopLevel "VkCopyCommandTransformInfoQCOM"
data CopyCommandTransformInfoQCOM = CopyCommandTransformInfoQCOM
  { -- No documentation found for Nested "VkCopyCommandTransformInfoQCOM" "transform"
