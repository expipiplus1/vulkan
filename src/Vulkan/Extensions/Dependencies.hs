...
import Vulkan.Extensions.VK_EXT_descriptor_buffer (pattern EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME)
import Vulkan.Extensions.VK_EXT_descriptor_indexing (pattern EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME)
import Vulkan.Extensions.VK_EXT_device_address_binding_report (pattern EXT_DEVICE_ADDRESS_BINDING_REPORT_EXTENSION_NAME)
import Vulkan.Extensions.VK_EXT_device_fault (pattern EXT_DEVICE_FAULT_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_extended_dynamic_state3 (pattern EXT_EXTENDED_DYNAMIC_STATE_3_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_pipeline_protected_access (pattern EXT_PIPELINE_PROTECTED_ACCESS_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_surface_maintenance1 (pattern EXT_SURFACE_MAINTENANCE_1_EXTENSION_NAME)
import Vulkan.Extensions.VK_EXT_swapchain_colorspace (pattern EXT_SWAPCHAIN_COLOR_SPACE_EXTENSION_NAME)
import Vulkan.Extensions.VK_EXT_swapchain_maintenance1 (pattern EXT_SWAPCHAIN_MAINTENANCE_1_EXTENSION_NAME)
...
extensionDependencies = \case
  ...
  EXT_DEVICE_FAULT_EXTENSION_NAME -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ...
  HUAWEI_CLUSTER_CULLING_SHADER_EXTENSION_NAME -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ...
  EXT_EXTENDED_DYNAMIC_STATE_3_EXTENSION_NAME -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
...
extensionCoreRequirement = \case
  ...
  EXT_MESH_SHADER_EXTENSION_NAME -> MAKE_API_VERSION 1 1 0
  ...
  EXT_PIPELINE_LIBRARY_GROUP_HANDLES_EXTENSION_NAME -> MAKE_API_VERSION 1 1 0
  _ -> API_VERSION_1_0
