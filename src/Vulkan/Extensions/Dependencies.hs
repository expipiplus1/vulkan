...
import Vulkan.Extensions.VK_ARM_rasterization_order_attachment_access (pattern ARM_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_attachment_feedback_loop_layout (pattern EXT_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_EXTENSION_NAME)
import Vulkan.Extensions.VK_EXT_blend_operation_advanced (pattern EXT_BLEND_OPERATION_ADVANCED_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_depth_clip_control (pattern EXT_DEPTH_CLIP_CONTROL_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_image_compression_control (pattern EXT_IMAGE_COMPRESSION_CONTROL_EXTENSION_NAME)
import Vulkan.Extensions.VK_EXT_image_compression_control_swapchain (pattern EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_multisampled_render_to_single_sampled (pattern EXT_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_EXTENSION_NAME)
import Vulkan.Extensions.VK_EXT_mutable_descriptor_type (pattern EXT_MUTABLE_DESCRIPTOR_TYPE_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_pipeline_robustness (pattern EXT_PIPELINE_ROBUSTNESS_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_rasterization_order_attachment_access (pattern EXT_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_EXT_shader_module_identifier (pattern EXT_SHADER_MODULE_IDENTIFIER_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_KHR_dynamic_rendering (pattern KHR_DYNAMIC_RENDERING_EXTENSION_NAME)
...
import Vulkan.Extensions.VK_QCOM_tile_properties (pattern QCOM_TILE_PROPERTIES_EXTENSION_NAME)
import Vulkan.Extensions.VK_QNX_screen_surface (pattern QNX_SCREEN_SURFACE_EXTENSION_NAME)
import Vulkan.Extensions.VK_SEC_amigo_profiling (pattern SEC_AMIGO_PROFILING_EXTENSION_NAME)
...
extensionDependencies = \case
  ...
  EXT_PIPELINE_ROBUSTNESS_EXTENSION_NAME          -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ...
  KHR_IMAGELESS_FRAMEBUFFER_EXTENSION_NAME -> [KHR_MAINTENANCE_2_EXTENSION_NAME, KHR_IMAGE_FORMAT_LIST_EXTENSION_NAME]
  KHR_CREATE_RENDERPASS_2_EXTENSION_NAME ->
    [ KHR_MULTIVIEW_EXTENSION_NAME
    , KHR_MAINTENANCE_2_EXTENSION_NAME
    , KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME
  ...
  EXT_INLINE_UNIFORM_BLOCK_EXTENSION_NAME ->
    [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME, KHR_MAINTENANCE_1_EXTENSION_NAME]
  EXT_SAMPLE_LOCATIONS_EXTENSION_NAME         -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  EXT_BLEND_OPERATION_ADVANCED_EXTENSION_NAME -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ...
  EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME ->
    [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME, KHR_MAINTENANCE_3_EXTENSION_NAME]
  ...
  EXT_CALIBRATED_TIMESTAMPS_EXTENSION_NAME    -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ...
  KHR_PRESENT_WAIT_EXTENSION_NAME ->
    [KHR_SWAPCHAIN_EXTENSION_NAME, KHR_PRESENT_ID_EXTENSION_NAME, KHR_SURFACE_EXTENSION_NAME]
  ...
  NV_DEVICE_GENERATED_COMMANDS_EXTENSION_NAME ->
    [KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME, KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ...
  KHR_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME      -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ...
  EXT_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_EXTENSION_NAME       -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  EXT_4444_FORMATS_EXTENSION_NAME                          -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ARM_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ...
  KHR_FORMAT_FEATURE_FLAGS_2_EXTENSION_NAME     -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
  ...
  EXT_PIPELINE_PROPERTIES_EXTENSION_NAME -> [KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME]
...
extensionCoreRequirement = \case
  ...
  KHR_RAY_TRACING_MAINTENANCE_1_EXTENSION_NAME -> MAKE_API_VERSION 1 1 0
  KHR_MAINTENANCE_4_EXTENSION_NAME -> MAKE_API_VERSION 1 1 0
  _                            -> API_VERSION_1_0
