...
--
-- -   #VUID-vkGetSemaphoreWin32HandleKHR-device-parameter# @device@ /must/
...
--
-- -   #VUID-vkGetSemaphoreWin32HandleKHR-pHandle-parameter# @pHandle@
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-vkImportSemaphoreWin32HandleKHR-device-parameter# @device@
...
--     valid 'ImportSemaphoreWin32HandleInfoKHR' structure
--
-- == Return Codes
--
-- [<https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#fundamentals-successcodes Success>]
