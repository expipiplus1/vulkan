...
-- = Description
--
-- -   #features-deviceGeneratedCommands# @deviceGeneratedCommands@
--     indicates whether the implementation supports functionality to
--     generate commands on the device. See
