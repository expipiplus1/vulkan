...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-magFilter-09598# If a
--     'Vulkan.Core10.Handles.Sampler' created with @magFilter@ or
...
--     'Vulkan.Core10.Enums.FormatFeatureFlagBits.FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_LINEAR_BIT'
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-mipmapMode-09599# If a
--     'Vulkan.Core10.Handles.Sampler' created with @mipmapMode@ equal to
--     'Vulkan.Core10.Enums.SamplerMipmapMode.SAMPLER_MIPMAP_MODE_LINEAR'
...
--     'Vulkan.Core10.Enums.FormatFeatureFlagBits.FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT'
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-unnormalizedCoordinates-09635# If a
...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-07888# If a
...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-02693# If the
...
--     'Vulkan.Core11.Promoted_From_VK_KHR_get_physical_device_properties2.getPhysicalDeviceImageFormatProperties2'
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-cubicRangeClamp-09212# If the
...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-reductionMode-09213# Any
...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-selectableCubicWeights-09214# If
--     the
...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-maintenance4-08602# If a
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#shaders-binding a bound shader>
--     was created as a 'Vulkan.Extensions.Handles.ShaderEXT' without the
--     'Vulkan.Extensions.VK_EXT_shader_object.SHADER_CREATE_DESCRIPTOR_HEAP_BIT_EXT'
--     flag or as part of a pipeline without the
...
--     'Vulkan.Core10.Enums.PipelineCreateFlagBits.PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT'
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-08116# Descriptors in bound
...
--     'Vulkan.Core10.Enums.PipelineCreateFlagBits.PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT'
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-08604# Descriptors in bound
--     descriptor buffers, specified via
--     'Vulkan.Extensions.VK_EXT_descriptor_buffer.cmdSetDescriptorBufferOffsetsEXT',
...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-08117# If the descriptors used
--     by the 'Vulkan.Core10.Handles.Pipeline' bound to the pipeline bind
--     point were specified via
--     'Vulkan.Extensions.VK_EXT_descriptor_buffer.cmdSetDescriptorBufferOffsetsEXT',
...
--     'Vulkan.Core10.Enums.PipelineCreateFlagBits.PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT'
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-08119# If a descriptor is
--     dynamically used with a 'Vulkan.Core10.Handles.Pipeline' created
--     with
--     'Vulkan.Core10.Enums.PipelineCreateFlagBits.PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT',
--     the descriptor memory /must/ be resident
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-08605# If a descriptor is
...
--     the descriptor memory /must/ be resident
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-08606# If the
...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-08608# If a pipeline is bound
...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-08612# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-robustBufferAccess robustBufferAccess>
...
--     to the same pipeline bind point
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-08613# If the
--     <https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#features-robustBufferAccess robustBufferAccess>
--     feature is not enabled, and any
--     'Vulkan.Extensions.Handles.ShaderEXT' bound to a stage corresponding
...
--     'Vulkan.Core10.Enums.SamplerCreateFlagBits.SAMPLER_CREATE_IMAGE_PROCESSING_BIT_QCOM'
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-OpImageBlockMatchWindow-09215# If a
...
--     'Vulkan.Core13.Enums.FormatFeatureFlags2.FORMAT_FEATURE_2_BLOCK_MATCHING_BIT_QCOM'
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-OpImageBlockMatchWindow-09216# If a
--     @OpImageBlockMatchWindow*QCOM@ or @OpImageBlockMatchGather*QCOM@
--     instruction is used to read from an
--     'Vulkan.Core10.Handles.ImageView' as a result of this command, then
...
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-09600# If a descriptor with
...
--     tracing pipeline
--
-- -   #VUID-vkCmdTraceRaysIndirect2KHR-None-09458# If the bound ray
--     tracing pipeline state was created with the
...
--
-- -   #VUID-VkTraceRaysIndirectCommand2KHR-flags-03513# If the bound ray
--     tracing pipeline was created with @flags@ that included
...
--     hit shader /must/ not be zero
--
-- -   #VUID-VkTraceRaysIndirectCommand2KHR-flags-03514# If the bound ray
--     tracing pipeline was created with @flags@ that included
...
--     intersection shader /must/ not be zero
--
