...
--     blending. If this is 'Vulkan.Core10.FundamentalTypes.FALSE', then
--     memory dependencies are required to guarantee order between two
--     advanced blending operations that occur on the same sample.
--
