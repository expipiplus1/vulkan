...
--     /must/ have been created with <VkImageCreateInfo.html tiling> equal
--     to
...
--     'ImageDrmFormatModifierPropertiesEXT' structure
--
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkDrmFormatModifierPropertiesListEXT-sType-sType# @sType@
--     /must/ be
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkImageDrmFormatModifierPropertiesEXT-sType-sType# @sType@
--     /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_PROPERTIES_EXT'
--
-- -   #VUID-VkImageDrmFormatModifierPropertiesEXT-pNext-pNext# @pNext@
--     /must/ be @NULL@
--
-- = See Also
--
