...
--     @bindInfoCount@ valid 'BindAccelerationStructureMemoryInfoKHR'
--     structures
--
...
--     @sType@ /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_KHR'
--
...
--
-- -   #limits-maxRecursionDepth# @maxRecursionDepth@ is the maximum number
--     of levels of recursion allowed in a trace command.
--
...
--     level acceleration structure.
--
-- -   @maxPrimitiveCount@ is the maximum number of triangles or AABBs in
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkPhysicalDeviceRayTracingPropertiesKHR-sType-sType# @sType@
--     /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_KHR'
--
-- = See Also
--
-- 'Vulkan.Core10.Enums.StructureType.StructureType'
data PhysicalDeviceRayTracingPropertiesKHR = PhysicalDeviceRayTracingPropertiesKHR
  { -- No documentation found for Nested "VkPhysicalDeviceRayTracingPropertiesKHR" "shaderGroupHandleSize"
    shaderGroupHandleSize :: Word32
  , -- No documentation found for Nested "VkPhysicalDeviceRayTracingPropertiesKHR" "maxRecursionDepth"
    maxRecursionDepth :: Word32
  , -- No documentation found for Nested "VkPhysicalDeviceRayTracingPropertiesKHR" "maxShaderGroupStride"
    maxShaderGroupStride :: Word32
  , -- No documentation found for Nested "VkPhysicalDeviceRayTracingPropertiesKHR" "shaderGroupBaseAlignment"
    shaderGroupBaseAlignment :: Word32
  , -- No documentation found for Nested "VkPhysicalDeviceRayTracingPropertiesKHR" "maxGeometryCount"
    maxGeometryCount :: Word64
  , -- No documentation found for Nested "VkPhysicalDeviceRayTracingPropertiesKHR" "maxInstanceCount"
    maxInstanceCount :: Word64
  , -- No documentation found for Nested "VkPhysicalDeviceRayTracingPropertiesKHR" "maxPrimitiveCount"
    maxPrimitiveCount :: Word64
  , -- No documentation found for Nested "VkPhysicalDeviceRayTracingPropertiesKHR" "maxDescriptorSetAccelerationStructures"
    maxDescriptorSetAccelerationStructures :: Word32
  , -- No documentation found for Nested "VkPhysicalDeviceRayTracingPropertiesKHR" "shaderGroupHandleCaptureReplaySize"
...
-- == Valid Usage
--
-- -   #VUID-VkTraceRaysIndirectCommandKHR-width-03519# @width@ /must/ be
...
--     'Vulkan.Core10.DeviceInitialization.PhysicalDeviceLimits'::@maxComputeWorkGroupCount@[1]
--
-- -   #VUID-VkTraceRaysIndirectCommandKHR-depth-03521# @depth@ /must/ be
--     less than or equal to
--     'Vulkan.Core10.DeviceInitialization.PhysicalDeviceLimits'::@maxComputeWorkGroupCount@[2]
--
-- = See Also
...
-- == Valid Usage
--
-- -   #VUID-VkAabbPositionsKHR-minX-03546# @minX@ /must/ be less than or
--     equal to @maxX@
--
-- -   #VUID-VkAabbPositionsKHR-minY-03547# @minY@ /must/ be less than or
--     equal to @maxY@
--
-- -   #VUID-VkAabbPositionsKHR-minZ-03548# @minZ@ /must/ be less than or
--     equal to @maxZ@
--
-- = See Also
--
...
--     single @int32_t@ was specified in their place
--
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkAccelerationStructureVersionKHR-sType-sType# @sType@ /must/
--     be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_ACCELERATION_STRUCTURE_VERSION_KHR'
--
-- -   #VUID-VkAccelerationStructureVersionKHR-pNext-pNext# @pNext@ /must/
--     be @NULL@
--
