...
--
withAccelerationStructureKHR :: forall io r . MonadIO io => Device -> AccelerationStructureCreateInfoKHR -> Maybe AllocationCallbacks -> (io (AccelerationStructureKHR) -> (GHC.Tuple.Unit AccelerationStructureKHR -> io ()) -> r) -> r
