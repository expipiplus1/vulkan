...
import {-# SOURCE #-} Vulkan.Core10.StaticMemoryFunctionality (CommandPoolMemoryConsumption)
...
import {-# SOURCE #-} Vulkan.Core10.FaultHandlingFunctionality (FaultData)
import {-# SOURCE #-} Vulkan.Core10.Enums.FaultQueryBehavior (FaultQueryBehavior)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_sci_sync (FenceGetSciSyncInfoNV)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_sci_sync (ImportFenceSciSyncInfoNV)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_sci_sync (ImportSemaphoreSciSyncInfoNV)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_memory_sci_buf (MemoryGetSciBufInfoNV)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_memory_sci_buf (MemorySciBufPropertiesNV)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_memory_sci_buf (NvSciBufAttrList)
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_memory_sci_buf (NvSciBufObj)
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_sci_sync (NvSciSyncAttrList)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_KHR_object_refresh (RefreshObjectListKHR)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_sci_sync (SciSyncAttributesInfoNV)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_sci_sync (SemaphoreGetSciSyncInfoNV)
...
import {-# SOURCE #-} Vulkan.Extensions.VK_NV_external_sci_sync2 (SemaphoreSciSyncPoolCreateInfoNV)
import {-# SOURCE #-} Vulkan.Extensions.Handles (SemaphoreSciSyncPoolNV)
...
data InstanceCmds = InstanceCmds
  ...
  , pVkGetPhysicalDeviceExternalMemorySciBufPropertiesNV :: FunPtr (Ptr PhysicalDevice_T -> ExternalMemoryHandleTypeFlagBits -> ("handle" ::: NvSciBufObj) -> ("pMemorySciBufProperties" ::: Ptr MemorySciBufPropertiesNV) -> IO Result)
  , pVkGetPhysicalDeviceSciBufAttributesNV :: FunPtr (Ptr PhysicalDevice_T -> ("pAttributes" ::: NvSciBufAttrList) -> IO Result)
  ...
  , pVkGetPhysicalDeviceSciSyncAttributesNV :: FunPtr (Ptr PhysicalDevice_T -> ("pSciSyncAttributesInfo" ::: Ptr SciSyncAttributesInfoNV) -> ("pAttributes" ::: NvSciSyncAttrList) -> IO Result)
  ...
  , pVkGetPhysicalDeviceRefreshableObjectTypesKHR :: FunPtr (Ptr PhysicalDevice_T -> ("pRefreshableObjectTypeCount" ::: Ptr Word32) -> ("pRefreshableObjectTypes" ::: Ptr ObjectType) -> IO Result)
...
initInstanceCmds handle = do
  ...
  vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV <- getInstanceProcAddr' handle (Ptr "vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV"#)
  vkGetPhysicalDeviceSciBufAttributesNV <- getInstanceProcAddr' handle (Ptr "vkGetPhysicalDeviceSciBufAttributesNV"#)
  ...
  vkGetPhysicalDeviceSciSyncAttributesNV <- getInstanceProcAddr' handle (Ptr "vkGetPhysicalDeviceSciSyncAttributesNV"#)
  ...
  vkGetPhysicalDeviceRefreshableObjectTypesKHR <- getInstanceProcAddr' handle (Ptr "vkGetPhysicalDeviceRefreshableObjectTypesKHR"#)
  ...
  pure $ InstanceCmds handle
    ...
    (castFunPtr @_ @(Ptr PhysicalDevice_T -> ExternalMemoryHandleTypeFlagBits -> ("handle" ::: NvSciBufObj) -> ("pMemorySciBufProperties" ::: Ptr MemorySciBufPropertiesNV) -> IO Result) vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV)
    (castFunPtr @_ @(Ptr PhysicalDevice_T -> ("pAttributes" ::: NvSciBufAttrList) -> IO Result) vkGetPhysicalDeviceSciBufAttributesNV)
    ...
    (castFunPtr @_ @(Ptr PhysicalDevice_T -> ("pSciSyncAttributesInfo" ::: Ptr SciSyncAttributesInfoNV) -> ("pAttributes" ::: NvSciSyncAttrList) -> IO Result) vkGetPhysicalDeviceSciSyncAttributesNV)
    ...
    (castFunPtr @_ @(Ptr PhysicalDevice_T -> ("pRefreshableObjectTypeCount" ::: Ptr Word32) -> ("pRefreshableObjectTypes" ::: Ptr ObjectType) -> IO Result) vkGetPhysicalDeviceRefreshableObjectTypesKHR)
...
data DeviceCmds = DeviceCmds
  ...
  , pVkGetMemorySciBufNV :: FunPtr (Ptr Device_T -> ("pGetSciBufInfo" ::: Ptr MemoryGetSciBufInfoNV) -> ("pHandle" ::: Ptr NvSciBufObj) -> IO Result)
  ...
  , pVkGetFenceSciSyncFenceNV :: FunPtr (Ptr Device_T -> ("pGetSciSyncHandleInfo" ::: Ptr FenceGetSciSyncInfoNV) -> ("pHandle" ::: Ptr ()) -> IO Result)
  , pVkGetFenceSciSyncObjNV :: FunPtr (Ptr Device_T -> ("pGetSciSyncHandleInfo" ::: Ptr FenceGetSciSyncInfoNV) -> ("pHandle" ::: Ptr ()) -> IO Result)
  , pVkImportFenceSciSyncFenceNV :: FunPtr (Ptr Device_T -> ("pImportFenceSciSyncInfo" ::: Ptr ImportFenceSciSyncInfoNV) -> IO Result)
  , pVkImportFenceSciSyncObjNV :: FunPtr (Ptr Device_T -> ("pImportFenceSciSyncInfo" ::: Ptr ImportFenceSciSyncInfoNV) -> IO Result)
  , pVkGetSemaphoreSciSyncObjNV :: FunPtr (Ptr Device_T -> ("pGetSciSyncInfo" ::: Ptr SemaphoreGetSciSyncInfoNV) -> ("pHandle" ::: Ptr ()) -> IO Result)
  , pVkImportSemaphoreSciSyncObjNV :: FunPtr (Ptr Device_T -> ("pImportSemaphoreSciSyncInfo" ::: Ptr ImportSemaphoreSciSyncInfoNV) -> IO Result)
  , pVkCreateSemaphoreSciSyncPoolNV :: FunPtr (Ptr Device_T -> ("pCreateInfo" ::: Ptr SemaphoreSciSyncPoolCreateInfoNV) -> ("pAllocator" ::: Ptr AllocationCallbacks) -> ("pSemaphorePool" ::: Ptr SemaphoreSciSyncPoolNV) -> IO Result)
  , pVkDestroySemaphoreSciSyncPoolNV :: FunPtr (Ptr Device_T -> ("semaphorePool" ::: SemaphoreSciSyncPoolNV) -> ("pAllocator" ::: Ptr AllocationCallbacks) -> IO ())
  ...
  , pVkGetFaultData :: FunPtr (Ptr Device_T -> FaultQueryBehavior -> ("pUnrecordedFaults" ::: Ptr Bool32) -> ("pFaultCount" ::: Ptr Word32) -> ("pFaults" ::: Ptr FaultData) -> IO Result)
  ...
  , pVkCmdRefreshObjectsKHR :: FunPtr (Ptr CommandBuffer_T -> ("pRefreshObjects" ::: Ptr RefreshObjectListKHR) -> IO ())
  ...
  , pVkGetCommandPoolMemoryConsumption :: FunPtr (Ptr Device_T -> CommandPool -> Ptr CommandBuffer_T -> ("pConsumption" ::: Ptr CommandPoolMemoryConsumption) -> IO ())
...
initDeviceCmds instanceCmds handle = do
  ...
  vkGetMemorySciBufNV <- getDeviceProcAddr' handle (Ptr "vkGetMemorySciBufNV"#)
  ...
  vkGetFenceSciSyncFenceNV <- getDeviceProcAddr' handle (Ptr "vkGetFenceSciSyncFenceNV"#)
  vkGetFenceSciSyncObjNV <- getDeviceProcAddr' handle (Ptr "vkGetFenceSciSyncObjNV"#)
  vkImportFenceSciSyncFenceNV <- getDeviceProcAddr' handle (Ptr "vkImportFenceSciSyncFenceNV"#)
  vkImportFenceSciSyncObjNV <- getDeviceProcAddr' handle (Ptr "vkImportFenceSciSyncObjNV"#)
  vkGetSemaphoreSciSyncObjNV <- getDeviceProcAddr' handle (Ptr "vkGetSemaphoreSciSyncObjNV"#)
  vkImportSemaphoreSciSyncObjNV <- getDeviceProcAddr' handle (Ptr "vkImportSemaphoreSciSyncObjNV"#)
  vkCreateSemaphoreSciSyncPoolNV <- getDeviceProcAddr' handle (Ptr "vkCreateSemaphoreSciSyncPoolNV"#)
  vkDestroySemaphoreSciSyncPoolNV <- getDeviceProcAddr' handle (Ptr "vkDestroySemaphoreSciSyncPoolNV"#)
  ...
  vkGetFaultData <- getDeviceProcAddr' handle (Ptr "vkGetFaultData"#)
  ...
  vkCmdRefreshObjectsKHR <- getDeviceProcAddr' handle (Ptr "vkCmdRefreshObjectsKHR"#)
  ...
  vkGetCommandPoolMemoryConsumption <- getDeviceProcAddr' handle (Ptr "vkGetCommandPoolMemoryConsumption"#)
  ...
  pure $ DeviceCmds handle
    ...
    (castFunPtr @_ @(Ptr Device_T -> ("pGetSciBufInfo" ::: Ptr MemoryGetSciBufInfoNV) -> ("pHandle" ::: Ptr NvSciBufObj) -> IO Result) vkGetMemorySciBufNV)
    ...
    (castFunPtr @_ @(Ptr Device_T -> ("pGetSciSyncHandleInfo" ::: Ptr FenceGetSciSyncInfoNV) -> ("pHandle" ::: Ptr ()) -> IO Result) vkGetFenceSciSyncFenceNV)
    (castFunPtr @_ @(Ptr Device_T -> ("pGetSciSyncHandleInfo" ::: Ptr FenceGetSciSyncInfoNV) -> ("pHandle" ::: Ptr ()) -> IO Result) vkGetFenceSciSyncObjNV)
    (castFunPtr @_ @(Ptr Device_T -> ("pImportFenceSciSyncInfo" ::: Ptr ImportFenceSciSyncInfoNV) -> IO Result) vkImportFenceSciSyncFenceNV)
    (castFunPtr @_ @(Ptr Device_T -> ("pImportFenceSciSyncInfo" ::: Ptr ImportFenceSciSyncInfoNV) -> IO Result) vkImportFenceSciSyncObjNV)
    (castFunPtr @_ @(Ptr Device_T -> ("pGetSciSyncInfo" ::: Ptr SemaphoreGetSciSyncInfoNV) -> ("pHandle" ::: Ptr ()) -> IO Result) vkGetSemaphoreSciSyncObjNV)
    (castFunPtr @_ @(Ptr Device_T -> ("pImportSemaphoreSciSyncInfo" ::: Ptr ImportSemaphoreSciSyncInfoNV) -> IO Result) vkImportSemaphoreSciSyncObjNV)
    (castFunPtr @_ @(Ptr Device_T -> ("pCreateInfo" ::: Ptr SemaphoreSciSyncPoolCreateInfoNV) -> ("pAllocator" ::: Ptr AllocationCallbacks) -> ("pSemaphorePool" ::: Ptr SemaphoreSciSyncPoolNV) -> IO Result) vkCreateSemaphoreSciSyncPoolNV)
    (castFunPtr @_ @(Ptr Device_T -> ("semaphorePool" ::: SemaphoreSciSyncPoolNV) -> ("pAllocator" ::: Ptr AllocationCallbacks) -> IO ()) vkDestroySemaphoreSciSyncPoolNV)
    ...
    (castFunPtr @_ @(Ptr Device_T -> FaultQueryBehavior -> ("pUnrecordedFaults" ::: Ptr Bool32) -> ("pFaultCount" ::: Ptr Word32) -> ("pFaults" ::: Ptr FaultData) -> IO Result) vkGetFaultData)
    ...
    (castFunPtr @_ @(Ptr CommandBuffer_T -> ("pRefreshObjects" ::: Ptr RefreshObjectListKHR) -> IO ()) vkCmdRefreshObjectsKHR)
    ...
    (castFunPtr @_ @(Ptr Device_T -> CommandPool -> Ptr CommandBuffer_T -> ("pConsumption" ::: Ptr CommandPoolMemoryConsumption) -> IO ()) vkGetCommandPoolMemoryConsumption)
