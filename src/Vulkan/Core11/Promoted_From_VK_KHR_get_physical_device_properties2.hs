...
--
-- -   #VUID-vkGetPhysicalDeviceFeatures2-pFeatures-parameter# @pFeatures@
--     /must/ be a valid pointer to a 'PhysicalDeviceFeatures2' structure
--
-- = See Also
--
...
--     'PhysicalDeviceProperties2' structure
--
-- = See Also
--
...
--     structure describing the fine-grained features of the Vulkan 1.0
--     API.
--
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkPhysicalDeviceFeatures2-sType-sType# @sType@ /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2'
--
-- = See Also
--
-- 'Vulkan.Core10.DeviceInitialization.PhysicalDeviceFeatures',
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkSparseImageFormatProperties2-sType-sType# @sType@ /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2'
--
-- -   #VUID-VkSparseImageFormatProperties2-pNext-pNext# @pNext@ /must/ be
--     @NULL@
--
-- = See Also
--
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkPhysicalDeviceSparseImageFormatInfo2-sType-sType# @sType@
--     /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2'
--
-- -   #VUID-VkPhysicalDeviceSparseImageFormatInfo2-pNext-pNext# @pNext@
--     /must/ be @NULL@
--
