...
-- corresponding to fine-grained features. Each structure in @pFeatures@
-- and its @pNext@ chain contains 'Vulkan.Core10.FundamentalTypes.Bool32'
-- members corresponding to fine-grained features. Each such member is
-- returned with a 'Vulkan.Core10.FundamentalTypes.TRUE' value indicating
-- that feature is supported on this physical device, or a
-- 'Vulkan.Core10.FundamentalTypes.FALSE' value indicating it is
-- unsupported.
--
...
instance Extensible PhysicalDeviceFeatures2 where
  ...
  extends _ f
    ...
    | Just Refl <- eqT @e @PhysicalDeviceRayTracingPositionFetchFeaturesKHR = Just f
    ...
    | Just Refl <- eqT @e @PhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT = Just f
...
--     'Vulkan.Core14.Promoted_From_VK_KHR_line_rasterizationRoadmap.PhysicalDeviceLineRasterizationProperties',
...
--     'Vulkan.Core14.Promoted_From_VK_KHR_push_descriptorRoadmap.PhysicalDevicePushDescriptorProperties',
...
instance Extensible PhysicalDeviceProperties2 where
  ...
  extends _ f
    ...
    | Just Refl <- eqT @e @PhysicalDeviceShaderObjectPropertiesEXT = Just f
    ...
    | Just Refl <- eqT @e @PhysicalDevicePipelineBinaryPropertiesKHR = Just f
    ...
    | Just Refl <- eqT @e @PhysicalDeviceTexelBufferAlignmentProperties = Just f
