...
--
-- -   #VUID-vkBindBufferMemory2-device-parameter# @device@ /must/ be a
--     valid 'Vulkan.Core10.Handles.Device' handle
--
-- -   #VUID-vkBindBufferMemory2-pBindInfos-parameter# @pBindInfos@ /must/
--     be a valid pointer to an array of @bindInfoCount@ valid
--     'BindBufferMemoryInfo' structures
--
-- -   #VUID-vkBindBufferMemory2-bindInfoCount-arraylength# @bindInfoCount@
