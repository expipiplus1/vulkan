...
--     structure.
--
-- -   #extension-limits-maxMultiviewViewCount# @maxMultiviewViewCount@ is
--     one greater than the maximum view index that /can/ be used in a
--     subpass.
--
-- -   #extension-limits-maxMultiviewInstanceIndex#
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkPhysicalDeviceMultiviewProperties-sType-sType# @sType@
--     /must/ be
--     'Vulkan.Core10.Enums.StructureType.STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PROPERTIES'
--
-- = See Also
--
-- 'Vulkan.Core10.Enums.StructureType.StructureType'
