...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkImageSubresource-aspectMask-parameter# @aspectMask@ /must/
--     be a valid combination of
--     'Vulkan.Core10.Enums.ImageAspectFlagBits.ImageAspectFlagBits' values
--
-- -   #VUID-VkImageSubresource-aspectMask-requiredbitmask# @aspectMask@
--     /must/ not be @0@
--
-- = See Also
--
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkSparseBufferMemoryBindInfo-buffer-parameter# @buffer@ /must/
--     be a valid 'Vulkan.Core10.Handles.Buffer' handle
--
-- -   #VUID-VkSparseBufferMemoryBindInfo-pBinds-parameter# @pBinds@ /must/
