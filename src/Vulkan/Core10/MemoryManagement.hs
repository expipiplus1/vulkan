...
--
-- -   #VUID-vkGetBufferMemoryRequirements-device-parameter# @device@
--     /must/ be a valid 'Vulkan.Core10.Handles.Device' handle
--
-- -   #VUID-vkGetBufferMemoryRequirements-buffer-parameter# @buffer@
...
--
-- -   #VUID-vkGetBufferMemoryRequirements-buffer-parent# @buffer@ /must/
