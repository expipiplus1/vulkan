...
--
-- -   #VUID-VkPushConstantRange-offset-00295# @offset@ /must/ be a
--     multiple of @4@
--
-- -   #VUID-VkPushConstantRange-size-00296# @size@ /must/ be greater than
--     @0@
--
-- -   #VUID-VkPushConstantRange-size-00297# @size@ /must/ be a multiple of
--     @4@
--
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-VkPushConstantRange-stageFlags-parameter# @stageFlags@ /must/
