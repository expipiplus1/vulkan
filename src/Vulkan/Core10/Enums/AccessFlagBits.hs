...
-- 'Vulkan.Extensions.VK_KHR_synchronization2.PIPELINE_STAGE_2_ALL_TRANSFER_BIT_KHR'
-- pipeline stage.
...
pattern ACCESS_NONE_KHR                             = AccessFlagBits 0x00000000
