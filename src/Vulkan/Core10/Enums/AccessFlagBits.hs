...
--     <https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#descriptorsets-storagetensor storage tensor>,
...
-- |                                                                                                                                             | 'Vulkan.Core13.Enums.PipelineStageFlags2.PIPELINE_STAGE_2_RESOLVE_BIT', 'Vulkan.Core13.Enums.PipelineStageFlags2.PIPELINE_STAGE_2_BLIT_BIT',         |
-- |                                                                                                                                             | 'Vulkan.Core13.Enums.PipelineStageFlags2.PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR',                                                     |
