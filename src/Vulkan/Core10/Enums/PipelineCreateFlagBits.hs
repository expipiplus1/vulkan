...
-- No documentation found for Nested "VkPipelineCreateFlagBits" "VK_PIPELINE_RASTERIZATION_STATE_CREATE_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT"
pattern PIPELINE_RASTERIZATION_STATE_CREATE_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT = PipelineCreateFlagBits 0x00400000
-- No documentation found for Nested "VkPipelineCreateFlagBits" "VK_PIPELINE_RASTERIZATION_STATE_CREATE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR"
pattern PIPELINE_RASTERIZATION_STATE_CREATE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR =
  PipelineCreateFlagBits 0x00200000
...
enumPrefixPipelineCreateFlagBits = "PIPELINE_"

showTablePipelineCreateFlagBits :: [(PipelineCreateFlagBits, String)]
showTablePipelineCreateFlagBits =
  [ (PIPELINE_CREATE_DISABLE_OPTIMIZATION_BIT                 , "CREATE_DISABLE_OPTIMIZATION_BIT")
  , (PIPELINE_CREATE_ALLOW_DERIVATIVES_BIT                    , "CREATE_ALLOW_DERIVATIVES_BIT")
  , (PIPELINE_CREATE_DERIVATIVE_BIT                           , "CREATE_DERIVATIVE_BIT")
  , (PIPELINE_CREATE_RAY_TRACING_ALLOW_MOTION_BIT_NV          , "CREATE_RAY_TRACING_ALLOW_MOTION_BIT_NV")
  , (PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BIT_EXT          , "CREATE_EARLY_RETURN_ON_FAILURE_BIT_EXT")
  , (PIPELINE_CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_EXT, "CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_EXT")
  , (PIPELINE_CREATE_LIBRARY_BIT_KHR                          , "CREATE_LIBRARY_BIT_KHR")
  , (PIPELINE_CREATE_INDIRECT_BINDABLE_BIT_NV                 , "CREATE_INDIRECT_BINDABLE_BIT_NV")
  , (PIPELINE_CREATE_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR , "CREATE_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR")
  , (PIPELINE_CREATE_CAPTURE_STATISTICS_BIT_KHR               , "CREATE_CAPTURE_STATISTICS_BIT_KHR")
  , (PIPELINE_CREATE_DEFER_COMPILE_BIT_NV                     , "CREATE_DEFER_COMPILE_BIT_NV")
  , ( PIPELINE_CREATE_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR
    , "CREATE_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR"
    )
  , (PIPELINE_CREATE_RAY_TRACING_SKIP_AABBS_BIT_KHR    , "CREATE_RAY_TRACING_SKIP_AABBS_BIT_KHR")
  , (PIPELINE_CREATE_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR, "CREATE_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR")
  , ( PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR
  ...
  , ( PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR
    , "CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR"
    )
  , (PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR, "CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR")
  , ( PIPELINE_RASTERIZATION_STATE_CREATE_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT
  ...
  , (PIPELINE_CREATE_DISPATCH_BASE_BIT               , "CREATE_DISPATCH_BASE_BIT")
  , (PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT, "CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT")
  ]
