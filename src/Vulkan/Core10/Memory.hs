...
-- == Valid Usage (Implicit)
--
-- -   #VUID-vkFlushMappedMemoryRanges-device-parameter# @device@ /must/ be
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-vkInvalidateMappedMemoryRanges-device-parameter# @device@
...
-- == Valid Usage (Implicit)
--
-- -   #VUID-vkGetDeviceMemoryCommitment-device-parameter# @device@ /must/
--     be a valid 'Vulkan.Core10.Handles.Device' handle
--
-- -   #VUID-vkGetDeviceMemoryCommitment-memory-parameter# @memory@ /must/
...
--
-- -   #VUID-vkGetDeviceMemoryCommitment-memory-parent# @memory@ /must/
