...
-- 'Vulkan.Core14.PromotedStreamingTransfers'.copyImageToImage',
-- 'Vulkan.Core14.PromotedStreamingTransfers'.copyImageToMemory',
-- 'Vulkan.Core14.PromotedStreamingTransfers'.copyImageToMemory',
-- 'Vulkan.Extensions.VK_KHR_acceleration_structure.copyMemoryToAccelerationStructureKHR',
-- 'Vulkan.Core14.PromotedStreamingTransfers'.copyMemoryToImage',
-- 'Vulkan.Core14.PromotedStreamingTransfers'.copyMemoryToImage',
...
-- 'Vulkan.Core14.Promoted_From_VK_KHR_maintenance5Roadmap.getImageSubresourceLayout2',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_maintenance5Roadmap.getImageSubresourceLayout2',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_maintenance5Roadmap.getImageSubresourceLayout2',
...
-- 'Vulkan.Core12.Promoted_From_VK_KHR_timeline_semaphore.signalSemaphore',
-- 'Vulkan.Core14.PromotedStreamingTransfers'.transitionImageLayout',
-- 'Vulkan.Core14.PromotedStreamingTransfers'.transitionImageLayout',
...
-- 'Vulkan.Core14.Promoted_From_VK_KHR_maintenance6AdditionalFunctionality'.cmdBindDescriptorSets2',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_maintenance6AdditionalFunctionality'.cmdBindDescriptorSets2',
...
-- 'Vulkan.Core14.Promoted_From_VK_KHR_maintenance6AdditionalFunctionality'.cmdPushDescriptorSet2',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_maintenance6AdditionalFunctionality'.cmdPushDescriptorSet2',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_push_descriptorRoadmap.cmdPushDescriptorSet',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_push_descriptorRoadmap.cmdPushDescriptorSetWithTemplate',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_maintenance6AdditionalFunctionality'.cmdPushDescriptorSetWithTemplate2',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_maintenance6AdditionalFunctionality'.cmdPushDescriptorSetWithTemplate2',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_push_descriptorRoadmap.cmdPushDescriptorSetWithTemplate',
...
-- 'Vulkan.Core14.Promoted_From_VK_KHR_dynamic_rendering_local_readRoadmap.cmdSetRenderingAttachmentLocations',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_dynamic_rendering_local_readRoadmap.cmdSetRenderingAttachmentLocations',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_dynamic_rendering_local_readRoadmap.cmdSetRenderingInputAttachmentIndices',
-- 'Vulkan.Core14.Promoted_From_VK_KHR_dynamic_rendering_local_readRoadmap.cmdSetRenderingInputAttachmentIndices',
...
-- 'Vulkan.Core14.Promoted_From_VK_KHR_map_memory2Roadmap.MemoryUnmapInfo',
