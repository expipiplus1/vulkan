...
--     /can/ be
--     <https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#descriptorsets-sampledimage sampled from>.
--
...
--     <https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#descriptorsets-storageimage storage images>
...
--     creating an
--     <https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#acceleration-structure acceleration structure>
...
-- specifies that the format can have different chroma, min, and mag
-- filters.
pattern FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT =
  FormatFeatureFlagBits2 0x0000000000080000
-- | 'FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT'
-- specifies that reconstruction is explicit, as described in
-- <https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/vkspec.html#textures-chroma-reconstruction>.
-- If this bit is not present, reconstruction is implicit by default.
pattern FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT =
  FormatFeatureFlagBits2 0x0000000000100000
-- | 'FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT'
...
pattern FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT =
  FormatFeatureFlagBits2 0x0000000000200000
-- | 'FORMAT_FEATURE_2_DISJOINT_BIT' specifies that a multi-planar image
-- /can/ have the
...
showTableFormatFeatureFlagBits2 =
  [ (FORMAT_FEATURE_2_SAMPLED_IMAGE_BIT              , "SAMPLED_IMAGE_BIT")
  , (FORMAT_FEATURE_2_STORAGE_IMAGE_BIT              , "STORAGE_IMAGE_BIT")
  , (FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT       , "STORAGE_IMAGE_ATOMIC_BIT")
  , (FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT       , "UNIFORM_TEXEL_BUFFER_BIT")
  , (FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT       , "STORAGE_TEXEL_BUFFER_BIT")
  , (FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT, "STORAGE_TEXEL_BUFFER_ATOMIC_BIT")
  , (FORMAT_FEATURE_2_VERTEX_BUFFER_BIT              , "VERTEX_BUFFER_BIT")
  , (FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT           , "COLOR_ATTACHMENT_BIT")
  , (FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT     , "COLOR_ATTACHMENT_BLEND_BIT")
  , (FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT   , "DEPTH_STENCIL_ATTACHMENT_BIT")
  , (FORMAT_FEATURE_2_BLIT_SRC_BIT                   , "BLIT_SRC_BIT")
  , (FORMAT_FEATURE_2_BLIT_DST_BIT                   , "BLIT_DST_BIT")
  , (FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT, "SAMPLED_IMAGE_FILTER_LINEAR_BIT")
  , (FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT , "SAMPLED_IMAGE_FILTER_CUBIC_BIT")
  , (FORMAT_FEATURE_2_TRANSFER_SRC_BIT               , "TRANSFER_SRC_BIT")
  , (FORMAT_FEATURE_2_TRANSFER_DST_BIT               , "TRANSFER_DST_BIT")
  , (FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT, "SAMPLED_IMAGE_FILTER_MINMAX_BIT")
  , (FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT    , "MIDPOINT_CHROMA_SAMPLES_BIT")
  , ( FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT
  ...
  , (FORMAT_FEATURE_2_DISJOINT_BIT                            , "DISJOINT_BIT")
  , (FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT              , "COSITED_CHROMA_SAMPLES_BIT")
  , (FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT         , "STORAGE_READ_WITHOUT_FORMAT_BIT")
  , (FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT        , "STORAGE_WRITE_WITHOUT_FORMAT_BIT")
  , (FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT      , "SAMPLED_IMAGE_DEPTH_COMPARISON_BIT")
...
instance Show FormatFeatureFlagBits2 where
  showsPrec = enumShowsPrec enumPrefixFormatFeatureFlagBits2
                            showTableFormatFeatureFlagBits2
...
instance Read FormatFeatureFlagBits2 where
  readPrec = enumReadPrec enumPrefixFormatFeatureFlagBits2
                          showTableFormatFeatureFlagBits2
                          conNameFormatFeatureFlagBits2
