...
module Graphics.Vulkan.Core10.Enums.StructureType  (StructureType( STRUCTURE_TYPE_APPLICATION_INFO
                                                                 ...
                                                                 , STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_KHR
...
-- No documentation found for Nested "VkStructureType" "VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_KHR"
pattern STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_KHR = StructureType 1000150007
...
instance Show StructureType where
  showsPrec p = \case
    ...
    STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_KHR -> showString "STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_KHR"
...
instance Read StructureType where
  readPrec = parens (choose [("STRUCTURE_TYPE_APPLICATION_INFO", pure STRUCTURE_TYPE_APPLICATION_INFO)
                            ...
                            , ("STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_KHR", pure STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_KHR)
