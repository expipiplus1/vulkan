...
-- allowed image view formats are specified by chaining an instance of the
-- 'Graphics.Vulkan.C.Extensions.VK_KHR_image_format_list.VkImageFormatListCreateInfoKHR'
-- structure to the @pNext@ chain of @VkSwapchainCreateInfoKHR@. In
-- addition, this flag also specifies that the swapchain /can/ be created
