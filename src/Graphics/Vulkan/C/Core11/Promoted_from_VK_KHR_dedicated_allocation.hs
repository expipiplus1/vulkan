...
--     have been created without @VK_IMAGE_CREATE_SPARSE_BINDING_BIT@ set
...
--     in 'Graphics.Vulkan.C.Core10.Buffer.VkBufferCreateInfo'::@flags@
--
-- -   If @image@ is not
...
-- -   If @image@ is not
--     'Graphics.Vulkan.C.Core10.Constants.VK_NULL_HANDLE', @image@ /must/
--     not have been created with @VK_IMAGE_CREATE_DISJOINT_BIT@ set in
