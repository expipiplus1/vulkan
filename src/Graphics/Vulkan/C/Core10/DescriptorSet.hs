...
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-updates-consecutive {html_spec_relative}#descriptorsets-updates-consecutive>
--
...
--     @srcBinding@ is @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@,
--     @srcArrayElement@ /must/ be an integer multiple of @4@
--
-- -   If the descriptor type of the descriptor set binding specified by
--     @dstBinding@ is @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@,
--     @dstArrayElement@ /must/ be an integer multiple of @4@
--
-- -   If the descriptor type of the descriptor set binding specified by
--     either @srcBinding@ or @dstBinding@ is
--     @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@, @descriptorCount@
...
data VkCopyDescriptorSet = VkCopyDescriptorSet
  ...
  -- @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@ then @srcArrayElement@
  ...
  -- @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@ then @dstArrayElement@
  ...
  -- @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@ then @descriptorCount@
...
-- (<https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#limits-maxUniformBufferRange maxUniformBufferRange>
-- or
-- <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#limits-maxStorageBufferRange maxStorageBufferRange>).
...
--     as defined by the
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#resources-image-layouts-matching-rule image layout matching rules>
--
...
--     @descriptorType@ is @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@ in
--     which case @descriptorCount@ is the size in bytes of the inline
--     uniform block . If @descriptorCount@ is zero this binding entry is
--     reserved and the resource /must/ not be accessed from any stage via
...
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-sampler sampler descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER@ specifies a
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-combinedimagesampler combined image sampler descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE@ specifies a
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-sampledimage sampled image descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_STORAGE_IMAGE@ specifies a
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-storageimage storage image descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER@ specifies a
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-uniformtexelbuffer uniform texel buffer descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER@ specifies a
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-storagetexelbuffer storage texel buffer descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER@ specifies a
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-uniformbuffer uniform buffer descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_STORAGE_BUFFER@ specifies a
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-storagebuffer storage buffer descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC@ specifies a
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-uniformbufferdynamic dynamic uniform buffer descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC@ specifies a
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-storagebufferdynamic dynamic storage buffer descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT@ specifies an
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-inputattachment input attachment descriptor>.
--
-- -   @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@ specifies an
...
-- @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@, none of the @pImageInfo@,
...
-- is @VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_NV@, in which case the
-- source data for the descriptor writes is taken from the instance of
-- 'Graphics.Vulkan.C.Extensions.VK_NV_ray_tracing.VkWriteDescriptorSetAccelerationStructureNV'
...
-- @dstBinding@ has a smaller byte size than the sum of @dstArrayElement@
-- and @descriptorCount@, then the remainder will be used to update the
-- subsequent binding - @dstBinding@+1 starting at offset zero. This falls
-- out as a special case of the above rule.
--
-- == Valid Usage
--
...
--     @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@, @dstArrayElement@
--     /must/ be an integer multiple of @4@
--
-- -   If @descriptorType@ is
--     @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@, @descriptorCount@
...
--
-- -   If @descriptorType@ is
--     @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@, the @pNext@ chain
--     /must/ include a
--     'Graphics.Vulkan.C.Extensions.VK_EXT_inline_uniform_block.VkWriteDescriptorSetInlineUniformBlockEXT'
--     structure whose @dataSize@ member equals @descriptorCount@
--
-- -   If @descriptorType@ is
--     @VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_NV@, the @pNext@ chain
--     /must/ include a
--     'Graphics.Vulkan.C.Extensions.VK_NV_ray_tracing.VkWriteDescriptorSetAccelerationStructureNV'
...
--     or
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-combinedimagesampler Combined Image Sampler>,
...
data VkWriteDescriptorSet = VkWriteDescriptorSet
  ...
  -- in the
  -- <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#resources-buffer-views Buffer Views>
...
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-binding consumed>.
--
...
--     @VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT@ /can/ be undefined
--     when the descriptor set is
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#descriptorsets-binding consumed>;
