...
--     processed by the
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#drawing input assembly>
...
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#shaders-vertex-execution invoked>.
--
-- -   @VK_QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_INVOCATIONS_BIT@
--     specifies that queries managed by the pool will count the number of
--     geometry shader invocations. This counter’s value is incremented
--     each time a geometry shader is
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#shaders-geometry-execution invoked>.
--     In the case of
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#geometry-invocations instanced geometry shaders>,
...
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#shaders-fragment-execution invoked>.
--
...
--     control shader is
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#shaders-tessellation-control-execution invoked>.
--
...
--     <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#shaders-tessellation-evaluation-execution invoked>.
--
...
-- described in
-- <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#queries-operation-undefined Query Operation>.
--
-- __Note__
--
...
data VkQueryPoolCreateInfo = VkQueryPoolCreateInfo
  ...
  -- <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#queries-pipestats {html_spec_relative}#queries-pipestats>.
...
-- <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#queries-occlusion occlusion query>.
...
-- <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#queries-pipestats pipeline statistics query>.
...
-- <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#queries-timestamps timestamp query>.
...
-- described
-- <https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#queries-wait-bit-not-set below>.
--
...
-- @VkDeviceSize@, 'VkQueryPool', 'VkQueryResultFlags'
foreign import ccall
#if !defined(SAFE_FOREIGN_CALLS)
  unsafe
#endif
