...
foreign import ccall unsafe "dynamic" mkVkGetDeviceProcAddr
...
foreign import ccall unsafe "dynamic" mkVkDestroyDevice
...
foreign import ccall unsafe "dynamic" mkVkGetDeviceQueue
...
foreign import ccall unsafe "dynamic" mkVkQueueSubmit
...
foreign import ccall unsafe "dynamic" mkVkQueueWaitIdle
...
foreign import ccall unsafe "dynamic" mkVkDeviceWaitIdle
...
foreign import ccall unsafe "dynamic" mkVkAllocateMemory
...
foreign import ccall unsafe "dynamic" mkVkFreeMemory
...
foreign import ccall unsafe "dynamic" mkVkMapMemory
...
foreign import ccall unsafe "dynamic" mkVkUnmapMemory
...
foreign import ccall unsafe "dynamic" mkVkFlushMappedMemoryRanges
...
foreign import ccall unsafe "dynamic" mkVkInvalidateMappedMemoryRanges
  :: FunPtr (("device" ::: VkDevice) -> ("memoryRangeCount" ::: Word32) -> ("pMemoryRanges" ::: Ptr VkMappedMemoryRange) -> IO VkResult) -> (("device" ::: VkDevice) -> ("memoryRangeCount" ::: Word32) -> ("pMemoryRanges" ::: Ptr VkMappedMemoryRange) -> IO VkResult)
...
foreign import ccall unsafe "dynamic" mkVkGetDeviceMemoryCommitment
...
foreign import ccall unsafe "dynamic" mkVkGetBufferMemoryRequirements
...
foreign import ccall unsafe "dynamic" mkVkBindBufferMemory
...
foreign import ccall unsafe "dynamic" mkVkGetImageMemoryRequirements
...
foreign import ccall unsafe "dynamic" mkVkGetImageSparseMemoryRequirements
...
foreign import ccall unsafe "dynamic" mkVkQueueBindSparse
...
foreign import ccall unsafe "dynamic" mkVkCreateFence
...
foreign import ccall unsafe "dynamic" mkVkDestroyFence
...
foreign import ccall unsafe "dynamic" mkVkResetFences
...
foreign import ccall unsafe "dynamic" mkVkGetFenceStatus
...
foreign import ccall unsafe "dynamic" mkVkWaitForFences
...
foreign import ccall unsafe "dynamic" mkVkCreateSemaphore
...
foreign import ccall unsafe "dynamic" mkVkDestroySemaphore
...
foreign import ccall unsafe "dynamic" mkVkCreateEvent
...
foreign import ccall unsafe "dynamic" mkVkDestroyEvent
...
foreign import ccall unsafe "dynamic" mkVkGetEventStatus
...
foreign import ccall unsafe "dynamic" mkVkSetEvent
  :: FunPtr (("device" ::: VkDevice) -> ("event" ::: VkEvent) -> IO VkResult) -> (("device" ::: VkDevice) -> ("event" ::: VkEvent) -> IO VkResult)
...
foreign import ccall unsafe "dynamic" mkVkResetEvent
  :: FunPtr (("device" ::: VkDevice) -> ("event" ::: VkEvent) -> IO VkResult) -> (("device" ::: VkDevice) -> ("event" ::: VkEvent) -> IO VkResult)
...
foreign import ccall unsafe "dynamic" mkVkCreateQueryPool
...
foreign import ccall unsafe "dynamic" mkVkDestroyQueryPool
...
foreign import ccall unsafe "dynamic" mkVkGetQueryPoolResults
...
foreign import ccall unsafe "dynamic" mkVkCreateBuffer
...
foreign import ccall unsafe "dynamic" mkVkDestroyBuffer
...
foreign import ccall unsafe "dynamic" mkVkCreateBufferView
...
foreign import ccall unsafe "dynamic" mkVkDestroyBufferView
...
foreign import ccall unsafe "dynamic" mkVkCreateImage
...
foreign import ccall unsafe "dynamic" mkVkDestroyImage
...
foreign import ccall unsafe "dynamic" mkVkGetImageSubresourceLayout
...
foreign import ccall unsafe "dynamic" mkVkCreateImageView
...
foreign import ccall unsafe "dynamic" mkVkDestroyImageView
...
foreign import ccall unsafe "dynamic" mkVkCreateShaderModule
...
foreign import ccall unsafe "dynamic" mkVkDestroyShaderModule
...
foreign import ccall unsafe "dynamic" mkVkCreatePipelineCache
...
foreign import ccall unsafe "dynamic" mkVkDestroyPipelineCache
...
foreign import ccall unsafe "dynamic" mkVkGetPipelineCacheData
...
foreign import ccall unsafe "dynamic" mkVkMergePipelineCaches
...
foreign import ccall unsafe "dynamic" mkVkCreateGraphicsPipelines
...
foreign import ccall unsafe "dynamic" mkVkCreateComputePipelines
...
foreign import ccall unsafe "dynamic" mkVkDestroyPipeline
...
foreign import ccall unsafe "dynamic" mkVkCreatePipelineLayout
...
foreign import ccall unsafe "dynamic" mkVkDestroyPipelineLayout
...
foreign import ccall unsafe "dynamic" mkVkCreateSampler
...
foreign import ccall unsafe "dynamic" mkVkDestroySampler
...
foreign import ccall unsafe "dynamic" mkVkCreateDescriptorSetLayout
...
foreign import ccall unsafe "dynamic" mkVkDestroyDescriptorSetLayout
...
foreign import ccall unsafe "dynamic" mkVkCreateDescriptorPool
...
foreign import ccall unsafe "dynamic" mkVkDestroyDescriptorPool
...
foreign import ccall unsafe "dynamic" mkVkResetDescriptorPool
...
foreign import ccall unsafe "dynamic" mkVkAllocateDescriptorSets
...
foreign import ccall unsafe "dynamic" mkVkFreeDescriptorSets
...
foreign import ccall unsafe "dynamic" mkVkUpdateDescriptorSets
...
foreign import ccall unsafe "dynamic" mkVkCreateFramebuffer
...
foreign import ccall unsafe "dynamic" mkVkDestroyFramebuffer
...
foreign import ccall unsafe "dynamic" mkVkCreateRenderPass
...
foreign import ccall unsafe "dynamic" mkVkDestroyRenderPass
...
foreign import ccall unsafe "dynamic" mkVkGetRenderAreaGranularity
...
foreign import ccall unsafe "dynamic" mkVkCreateCommandPool
...
foreign import ccall unsafe "dynamic" mkVkDestroyCommandPool
...
foreign import ccall unsafe "dynamic" mkVkResetCommandPool
...
foreign import ccall unsafe "dynamic" mkVkAllocateCommandBuffers
...
foreign import ccall unsafe "dynamic" mkVkFreeCommandBuffers
...
foreign import ccall unsafe "dynamic" mkVkBeginCommandBuffer
...
foreign import ccall unsafe "dynamic" mkVkEndCommandBuffer
...
foreign import ccall unsafe "dynamic" mkVkResetCommandBuffer
...
foreign import ccall unsafe "dynamic" mkVkCmdBindPipeline
...
foreign import ccall unsafe "dynamic" mkVkCmdSetViewport
...
foreign import ccall unsafe "dynamic" mkVkCmdSetScissor
...
foreign import ccall unsafe "dynamic" mkVkCmdSetLineWidth
...
foreign import ccall unsafe "dynamic" mkVkCmdSetDepthBias
...
foreign import ccall unsafe "dynamic" mkVkCmdSetBlendConstants
...
foreign import ccall unsafe "dynamic" mkVkCmdSetDepthBounds
...
foreign import ccall unsafe "dynamic" mkVkCmdSetStencilCompareMask
...
foreign import ccall unsafe "dynamic" mkVkCmdSetStencilWriteMask
...
foreign import ccall unsafe "dynamic" mkVkCmdSetStencilReference
...
foreign import ccall unsafe "dynamic" mkVkCmdBindDescriptorSets
...
foreign import ccall unsafe "dynamic" mkVkCmdBindIndexBuffer
...
foreign import ccall unsafe "dynamic" mkVkCmdBindVertexBuffers
...
foreign import ccall unsafe "dynamic" mkVkCmdDraw
...
foreign import ccall unsafe "dynamic" mkVkCmdDrawIndexed
...
foreign import ccall unsafe "dynamic" mkVkCmdDrawIndirect
...
foreign import ccall unsafe "dynamic" mkVkCmdDrawIndexedIndirect
  :: FunPtr (("commandBuffer" ::: VkCommandBuffer) -> ("buffer" ::: VkBuffer) -> ("offset" ::: VkDeviceSize) -> ("drawCount" ::: Word32) -> ("stride" ::: Word32) -> IO ()) -> (("commandBuffer" ::: VkCommandBuffer) -> ("buffer" ::: VkBuffer) -> ("offset" ::: VkDeviceSize) -> ("drawCount" ::: Word32) -> ("stride" ::: Word32) -> IO ())
...
foreign import ccall unsafe "dynamic" mkVkCmdDispatch
...
foreign import ccall unsafe "dynamic" mkVkCmdDispatchIndirect
...
foreign import ccall unsafe "dynamic" mkVkCmdCopyBuffer
...
foreign import ccall unsafe "dynamic" mkVkCmdCopyImage
...
foreign import ccall unsafe "dynamic" mkVkCmdBlitImage
...
foreign import ccall unsafe "dynamic" mkVkCmdCopyBufferToImage
...
foreign import ccall unsafe "dynamic" mkVkCmdCopyImageToBuffer
...
foreign import ccall unsafe "dynamic" mkVkCmdUpdateBuffer
...
foreign import ccall unsafe "dynamic" mkVkCmdFillBuffer
...
foreign import ccall unsafe "dynamic" mkVkCmdClearColorImage
...
foreign import ccall unsafe "dynamic" mkVkCmdClearDepthStencilImage
...
foreign import ccall unsafe "dynamic" mkVkCmdClearAttachments
...
foreign import ccall unsafe "dynamic" mkVkCmdResolveImage
...
foreign import ccall unsafe "dynamic" mkVkCmdSetEvent
...
foreign import ccall unsafe "dynamic" mkVkCmdResetEvent
  :: FunPtr (("commandBuffer" ::: VkCommandBuffer) -> ("event" ::: VkEvent) -> ("stageMask" ::: VkPipelineStageFlags) -> IO ()) -> (("commandBuffer" ::: VkCommandBuffer) -> ("event" ::: VkEvent) -> ("stageMask" ::: VkPipelineStageFlags) -> IO ())
...
foreign import ccall unsafe "dynamic" mkVkCmdWaitEvents
...
foreign import ccall unsafe "dynamic" mkVkCmdPipelineBarrier
...
foreign import ccall unsafe "dynamic" mkVkCmdBeginQuery
...
foreign import ccall unsafe "dynamic" mkVkCmdEndQuery
...
foreign import ccall unsafe "dynamic" mkVkCmdResetQueryPool
...
foreign import ccall unsafe "dynamic" mkVkCmdWriteTimestamp
...
foreign import ccall unsafe "dynamic" mkVkCmdCopyQueryPoolResults
...
foreign import ccall unsafe "dynamic" mkVkCmdPushConstants
...
foreign import ccall unsafe "dynamic" mkVkCmdBeginRenderPass
...
foreign import ccall unsafe "dynamic" mkVkCmdNextSubpass
...
foreign import ccall unsafe "dynamic" mkVkCmdEndRenderPass
...
foreign import ccall unsafe "dynamic" mkVkCmdExecuteCommands
...
foreign import ccall unsafe "dynamic" mkVkCreateSharedSwapchainsKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateSwapchainKHR
...
foreign import ccall unsafe "dynamic" mkVkDestroySwapchainKHR
...
foreign import ccall unsafe "dynamic" mkVkGetSwapchainImagesKHR
...
foreign import ccall unsafe "dynamic" mkVkAcquireNextImageKHR
...
foreign import ccall unsafe "dynamic" mkVkQueuePresentKHR
...
foreign import ccall unsafe "dynamic" mkVkDebugMarkerSetObjectNameEXT
...
foreign import ccall unsafe "dynamic" mkVkDebugMarkerSetObjectTagEXT
...
foreign import ccall unsafe "dynamic" mkVkCmdDebugMarkerBeginEXT
...
foreign import ccall unsafe "dynamic" mkVkCmdDebugMarkerEndEXT
  :: FunPtr (("commandBuffer" ::: VkCommandBuffer) -> IO ()) -> (("commandBuffer" ::: VkCommandBuffer) -> IO ())
...
foreign import ccall unsafe "dynamic" mkVkCmdDebugMarkerInsertEXT
  :: FunPtr (("commandBuffer" ::: VkCommandBuffer) -> ("pMarkerInfo" ::: Ptr VkDebugMarkerMarkerInfoEXT) -> IO ()) -> (("commandBuffer" ::: VkCommandBuffer) -> ("pMarkerInfo" ::: Ptr VkDebugMarkerMarkerInfoEXT) -> IO ())
...
foreign import ccall unsafe "dynamic" mkVkGetMemoryWin32HandleNV
...
foreign import ccall unsafe "dynamic" mkVkCmdDrawIndirectCountAMD
...
foreign import ccall unsafe "dynamic" mkVkCmdDrawIndexedIndirectCountAMD
  :: FunPtr (("commandBuffer" ::: VkCommandBuffer) -> ("buffer" ::: VkBuffer) -> ("offset" ::: VkDeviceSize) -> ("countBuffer" ::: VkBuffer) -> ("countBufferOffset" ::: VkDeviceSize) -> ("maxDrawCount" ::: Word32) -> ("stride" ::: Word32) -> IO ()) -> (("commandBuffer" ::: VkCommandBuffer) -> ("buffer" ::: VkBuffer) -> ("offset" ::: VkDeviceSize) -> ("countBuffer" ::: VkBuffer) -> ("countBufferOffset" ::: VkDeviceSize) -> ("maxDrawCount" ::: Word32) -> ("stride" ::: Word32) -> IO ())
...
foreign import ccall unsafe "dynamic" mkVkCmdProcessCommandsNVX
...
foreign import ccall unsafe "dynamic" mkVkCmdReserveSpaceForCommandsNVX
...
foreign import ccall unsafe "dynamic" mkVkCreateIndirectCommandsLayoutNVX
...
foreign import ccall unsafe "dynamic" mkVkDestroyIndirectCommandsLayoutNVX
...
foreign import ccall unsafe "dynamic" mkVkCreateObjectTableNVX
...
foreign import ccall unsafe "dynamic" mkVkDestroyObjectTableNVX
...
foreign import ccall unsafe "dynamic" mkVkRegisterObjectsNVX
...
foreign import ccall unsafe "dynamic" mkVkUnregisterObjectsNVX
...
foreign import ccall unsafe "dynamic" mkVkCmdPushDescriptorSetKHR
...
foreign import ccall unsafe "dynamic" mkVkTrimCommandPool
...
foreign import ccall unsafe "dynamic" mkVkGetMemoryWin32HandleKHR
...
foreign import ccall unsafe "dynamic" mkVkGetMemoryWin32HandlePropertiesKHR
...
foreign import ccall unsafe "dynamic" mkVkGetMemoryFdKHR
...
foreign import ccall unsafe "dynamic" mkVkGetMemoryFdPropertiesKHR
...
foreign import ccall unsafe "dynamic" mkVkGetSemaphoreWin32HandleKHR
...
foreign import ccall unsafe "dynamic" mkVkImportSemaphoreWin32HandleKHR
...
foreign import ccall unsafe "dynamic" mkVkGetSemaphoreFdKHR
...
foreign import ccall unsafe "dynamic" mkVkImportSemaphoreFdKHR
...
foreign import ccall unsafe "dynamic" mkVkGetFenceWin32HandleKHR
...
foreign import ccall unsafe "dynamic" mkVkImportFenceWin32HandleKHR
...
foreign import ccall unsafe "dynamic" mkVkGetFenceFdKHR
...
foreign import ccall unsafe "dynamic" mkVkImportFenceFdKHR
...
foreign import ccall unsafe "dynamic" mkVkRegisterDeviceEventEXT
...
foreign import ccall unsafe "dynamic" mkVkRegisterDisplayEventEXT
...
foreign import ccall unsafe "dynamic" mkVkGetSwapchainCounterEXT
...
foreign import ccall unsafe "dynamic" mkVkGetDeviceGroupPeerMemoryFeatures
...
foreign import ccall unsafe "dynamic" mkVkBindBufferMemory2
...
foreign import ccall unsafe "dynamic" mkVkBindImageMemory2
...
foreign import ccall unsafe "dynamic" mkVkCmdSetDeviceMask
...
foreign import ccall unsafe "dynamic" mkVkGetDeviceGroupPresentCapabilitiesKHR
...
foreign import ccall unsafe "dynamic" mkVkAcquireNextImage2KHR
...
foreign import ccall unsafe "dynamic" mkVkCmdDispatchBase
...
foreign import ccall unsafe "dynamic" mkVkCreateDescriptorUpdateTemplate
...
foreign import ccall unsafe "dynamic" mkVkDestroyDescriptorUpdateTemplate
...
foreign import ccall unsafe "dynamic" mkVkUpdateDescriptorSetWithTemplate
...
foreign import ccall unsafe "dynamic" mkVkCmdPushDescriptorSetWithTemplateKHR
...
foreign import ccall unsafe "dynamic" mkVkSetHdrMetadataEXT
...
foreign import ccall unsafe "dynamic" mkVkGetSwapchainStatusKHR
...
foreign import ccall unsafe "dynamic" mkVkGetRefreshCycleDurationGOOGLE
...
foreign import ccall unsafe "dynamic" mkVkGetPastPresentationTimingGOOGLE
...
foreign import ccall unsafe "dynamic" mkVkCmdSetViewportWScalingNV
...
foreign import ccall unsafe "dynamic" mkVkCmdSetDiscardRectangleEXT
...
foreign import ccall unsafe "dynamic" mkVkCmdSetSampleLocationsEXT
...
foreign import ccall unsafe "dynamic" mkVkGetBufferMemoryRequirements2
...
foreign import ccall unsafe "dynamic" mkVkGetImageMemoryRequirements2
...
foreign import ccall unsafe "dynamic" mkVkGetImageSparseMemoryRequirements2
...
foreign import ccall unsafe "dynamic" mkVkCreateSamplerYcbcrConversion
...
foreign import ccall unsafe "dynamic" mkVkDestroySamplerYcbcrConversion
...
foreign import ccall unsafe "dynamic" mkVkGetDeviceQueue2
...
foreign import ccall unsafe "dynamic" mkVkCreateValidationCacheEXT
...
foreign import ccall unsafe "dynamic" mkVkDestroyValidationCacheEXT
...
foreign import ccall unsafe "dynamic" mkVkGetValidationCacheDataEXT
...
foreign import ccall unsafe "dynamic" mkVkMergeValidationCachesEXT
...
foreign import ccall unsafe "dynamic" mkVkGetDescriptorSetLayoutSupport
...
foreign import ccall unsafe "dynamic" mkVkGetSwapchainGrallocUsageANDROID
...
foreign import ccall unsafe "dynamic" mkVkAcquireImageANDROID
...
foreign import ccall unsafe "dynamic" mkVkQueueSignalReleaseImageANDROID
...
foreign import ccall unsafe "dynamic" mkVkGetShaderInfoAMD
...
foreign import ccall unsafe "dynamic" mkVkSetDebugUtilsObjectNameEXT
...
foreign import ccall unsafe "dynamic" mkVkSetDebugUtilsObjectTagEXT
...
foreign import ccall unsafe "dynamic" mkVkQueueBeginDebugUtilsLabelEXT
...
foreign import ccall unsafe "dynamic" mkVkQueueEndDebugUtilsLabelEXT
...
foreign import ccall unsafe "dynamic" mkVkQueueInsertDebugUtilsLabelEXT
  :: FunPtr (("queue" ::: VkQueue) -> ("pLabelInfo" ::: Ptr VkDebugUtilsLabelEXT) -> IO ()) -> (("queue" ::: VkQueue) -> ("pLabelInfo" ::: Ptr VkDebugUtilsLabelEXT) -> IO ())
...
foreign import ccall unsafe "dynamic" mkVkCmdBeginDebugUtilsLabelEXT
...
foreign import ccall unsafe "dynamic" mkVkCmdEndDebugUtilsLabelEXT
  :: FunPtr (("commandBuffer" ::: VkCommandBuffer) -> IO ()) -> (("commandBuffer" ::: VkCommandBuffer) -> IO ())
...
foreign import ccall unsafe "dynamic" mkVkCmdInsertDebugUtilsLabelEXT
  :: FunPtr (("commandBuffer" ::: VkCommandBuffer) -> ("pLabelInfo" ::: Ptr VkDebugUtilsLabelEXT) -> IO ()) -> (("commandBuffer" ::: VkCommandBuffer) -> ("pLabelInfo" ::: Ptr VkDebugUtilsLabelEXT) -> IO ())
...
foreign import ccall unsafe "dynamic" mkVkGetMemoryHostPointerPropertiesEXT
...
foreign import ccall unsafe "dynamic" mkVkCmdWriteBufferMarkerAMD
...
foreign import ccall unsafe "dynamic" mkVkGetAndroidHardwareBufferPropertiesANDROID
...
foreign import ccall unsafe "dynamic" mkVkGetMemoryAndroidHardwareBufferANDROID
...
foreign import ccall unsafe "dynamic" mkVkDestroyInstance
...
foreign import ccall unsafe "dynamic" mkVkEnumeratePhysicalDevices
...
foreign import ccall unsafe "dynamic" mkVkGetInstanceProcAddr
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceProperties
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceQueueFamilyProperties
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceMemoryProperties
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceFeatures
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceFormatProperties
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceImageFormatProperties
...
foreign import ccall unsafe "dynamic" mkVkCreateDevice
...
foreign import ccall unsafe "dynamic" mkVkEnumerateDeviceLayerProperties
...
foreign import ccall unsafe "dynamic" mkVkEnumerateDeviceExtensionProperties
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceSparseImageFormatProperties
...
foreign import ccall unsafe "dynamic" mkVkCreateAndroidSurfaceKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceDisplayPropertiesKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceDisplayPlanePropertiesKHR
...
foreign import ccall unsafe "dynamic" mkVkGetDisplayPlaneSupportedDisplaysKHR
...
foreign import ccall unsafe "dynamic" mkVkGetDisplayModePropertiesKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateDisplayModeKHR
...
foreign import ccall unsafe "dynamic" mkVkGetDisplayPlaneCapabilitiesKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateDisplayPlaneSurfaceKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateMirSurfaceKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceMirPresentationSupportKHR
...
foreign import ccall unsafe "dynamic" mkVkDestroySurfaceKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceSurfaceSupportKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceSurfaceCapabilitiesKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceSurfaceFormatsKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceSurfacePresentModesKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateViSurfaceNN
...
foreign import ccall unsafe "dynamic" mkVkCreateWaylandSurfaceKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceWaylandPresentationSupportKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateWin32SurfaceKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceWin32PresentationSupportKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateXlibSurfaceKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceXlibPresentationSupportKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateXcbSurfaceKHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceXcbPresentationSupportKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateDebugReportCallbackEXT
...
foreign import ccall unsafe "dynamic" mkVkDestroyDebugReportCallbackEXT
...
foreign import ccall unsafe "dynamic" mkVkDebugReportMessageEXT
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceExternalImageFormatPropertiesNV
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceGeneratedCommandsPropertiesNVX
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceFeatures2
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceProperties2
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceFormatProperties2
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceImageFormatProperties2
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceQueueFamilyProperties2
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceMemoryProperties2
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceSparseImageFormatProperties2
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceExternalBufferProperties
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceExternalSemaphoreProperties
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceExternalFenceProperties
...
foreign import ccall unsafe "dynamic" mkVkReleaseDisplayEXT
...
foreign import ccall unsafe "dynamic" mkVkAcquireXlibDisplayEXT
...
foreign import ccall unsafe "dynamic" mkVkGetRandROutputDisplayEXT
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceSurfaceCapabilities2EXT
...
foreign import ccall unsafe "dynamic" mkVkEnumeratePhysicalDeviceGroups
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDevicePresentRectanglesKHR
...
foreign import ccall unsafe "dynamic" mkVkCreateIOSSurfaceMVK
...
foreign import ccall unsafe "dynamic" mkVkCreateMacOSSurfaceMVK
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceMultisamplePropertiesEXT
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceSurfaceCapabilities2KHR
...
foreign import ccall unsafe "dynamic" mkVkGetPhysicalDeviceSurfaceFormats2KHR
...
foreign import ccall unsafe "dynamic" mkVkCreateDebugUtilsMessengerEXT
...
foreign import ccall unsafe "dynamic" mkVkDestroyDebugUtilsMessengerEXT
...
foreign import ccall unsafe "dynamic" mkVkSubmitDebugUtilsMessageEXT
