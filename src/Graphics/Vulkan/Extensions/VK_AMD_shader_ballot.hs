...
pattern AMD_SHADER_BALLOT_EXTENSION_NAME :: (Eq a, IsString a) => a
pattern AMD_SHADER_BALLOT_EXTENSION_NAME = VK_AMD_SHADER_BALLOT_EXTENSION_NAME

-- No documentation found for TopLevel "VK_AMD_SHADER_BALLOT_SPEC_VERSION"
pattern AMD_SHADER_BALLOT_SPEC_VERSION :: Integral a => a
pattern AMD_SHADER_BALLOT_SPEC_VERSION = VK_AMD_SHADER_BALLOT_SPEC_VERSION
