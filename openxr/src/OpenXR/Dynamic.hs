...
data InstanceCmds = InstanceCmds
  ...
  , pXrGetVulkanGraphicsDeviceKHR :: FunPtr (Ptr Instance_T -> SystemId -> ("vkInstance" ::: OpenXR.VulkanTypes.Instance) -> ("vkPhysicalDevice" ::: Ptr OpenXR.VulkanTypes.PhysicalDevice) -> IO Result)
  ...
  , pXrCreateVulkanInstanceKHR :: FunPtr (Ptr Instance_T -> Ptr VulkanInstanceCreateInfoKHR -> ("vulkanInstance" ::: Ptr OpenXR.VulkanTypes.Instance) -> ("vulkanResult" ::: Ptr OpenXR.VulkanTypes.Result) -> IO Result)
  , pXrCreateVulkanDeviceKHR :: FunPtr (Ptr Instance_T -> Ptr VulkanDeviceCreateInfoKHR -> ("vulkanDevice" ::: Ptr OpenXR.VulkanTypes.Device) -> ("vulkanResult" ::: Ptr OpenXR.VulkanTypes.Result) -> IO Result)
  , pXrGetVulkanGraphicsDevice2KHR :: FunPtr (Ptr Instance_T -> Ptr VulkanGraphicsDeviceGetInfoKHR -> ("vulkanPhysicalDevice" ::: Ptr OpenXR.VulkanTypes.PhysicalDevice) -> IO Result)
...
initInstanceCmds handle = do
  ...
  pure $ InstanceCmds handle
    ...
    (castFunPtr @_ @(Ptr Instance_T -> SystemId -> ("vkInstance" ::: OpenXR.VulkanTypes.Instance) -> ("vkPhysicalDevice" ::: Ptr OpenXR.VulkanTypes.PhysicalDevice) -> IO Result) xrGetVulkanGraphicsDeviceKHR)
    ...
    (castFunPtr @_ @(Ptr Instance_T -> Ptr VulkanInstanceCreateInfoKHR -> ("vulkanInstance" ::: Ptr OpenXR.VulkanTypes.Instance) -> ("vulkanResult" ::: Ptr OpenXR.VulkanTypes.Result) -> IO Result) xrCreateVulkanInstanceKHR)
    (castFunPtr @_ @(Ptr Instance_T -> Ptr VulkanDeviceCreateInfoKHR -> ("vulkanDevice" ::: Ptr OpenXR.VulkanTypes.Device) -> ("vulkanResult" ::: Ptr OpenXR.VulkanTypes.Result) -> IO Result) xrCreateVulkanDeviceKHR)
    (castFunPtr @_ @(Ptr Instance_T -> Ptr VulkanGraphicsDeviceGetInfoKHR -> ("vulkanPhysicalDevice" ::: Ptr OpenXR.VulkanTypes.PhysicalDevice) -> IO Result) xrGetVulkanGraphicsDevice2KHR)
