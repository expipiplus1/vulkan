...
instance Show ActionType where
  showsPrec =
    enumShowsPrec enumPrefixActionType showTableActionType conNameActionType (\(ActionType x) -> x) (showsPrec 11)

instance Read ActionType where
  readPrec = enumReadPrec enumPrefixActionType showTableActionType conNameActionType ActionType
