...
allocateGlitchPipeline :: Vk.Device -> ResourceT IO GlitchPipeline
allocateGlitchPipeline dev = do
...
allocateGlitchDescriptorSets dev layout views = do
