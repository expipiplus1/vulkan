...
ignoredUnexportedNames =
  ...
  , PatternName "VK_QUERY_TYPE_RESERVED_8"
  , PatternName "VK_QUERY_TYPE_RESERVED_4"
  , PatternName "VK_QUEUE_RESERVED_6_BIT_KHR"
  , PatternName "VK_QUEUE_RESERVED_5_BIT_KHR"
  , PatternName "VK_ACCESS_RESERVED_30_BIT_KHR"
  , PatternName "VK_ACCESS_RESERVED_31_BIT_KHR"
  , PatternName "VK_ACCESS_RESERVED_28_BIT_KHR"
  , PatternName "VK_ACCESS_RESERVED_29_BIT_KHR"
  , PatternName "VK_BUFFER_USAGE_RESERVED_15_BIT_KHR"
  , PatternName "VK_BUFFER_USAGE_RESERVED_16_BIT_KHR"
  , PatternName "VK_BUFFER_USAGE_RESERVED_13_BIT_KHR"
  , PatternName "VK_BUFFER_USAGE_RESERVED_14_BIT_KHR"
  , PatternName "VK_IMAGE_USAGE_RESERVED_13_BIT_KHR"
  , PatternName "VK_IMAGE_USAGE_RESERVED_14_BIT_KHR"
  , PatternName "VK_IMAGE_USAGE_RESERVED_15_BIT_KHR"
  , PatternName "VK_IMAGE_USAGE_RESERVED_10_BIT_KHR"
  , PatternName "VK_IMAGE_USAGE_RESERVED_11_BIT_KHR"
  , PatternName "VK_IMAGE_USAGE_RESERVED_12_BIT_KHR"
  , PatternName "VK_FORMAT_FEATURE_RESERVED_27_BIT_KHR"
  , PatternName "VK_FORMAT_FEATURE_RESERVED_28_BIT_KHR"
  , PatternName "VK_FORMAT_FEATURE_RESERVED_25_BIT_KHR"
  , PatternName "VK_FORMAT_FEATURE_RESERVED_26_BIT_KHR"
  , PatternName "VK_SUBPASS_DESCRIPTION_RESERVED_2_BIT_QCOM"
  , PatternName "VK_SUBPASS_DESCRIPTION_RESERVED_3_BIT_QCOM"
  , PatternName "VK_PIPELINE_STAGE_RESERVED_27_BIT_KHR"
  , PatternName "VK_PIPELINE_STAGE_RESERVED_26_BIT_KHR"
  , TypeName "VendorId"
  ]
